...
interface DataRetrieverPluginInterface {

	/**
	 * Discoveries new products and starts a task
	 * for each download to be scheduled
	 */
	public function discovery();
	
	/**
	 * Performs the actual download of a product
	 */

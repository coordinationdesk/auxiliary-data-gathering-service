...
ALTER TABLE public.auth_group OWNER TO acsdba;

--
-- Name: auth_group_id_seq; Type: SEQUENCE; Schema: public; Owner: acsdba
--
...
ALTER TABLE public.auth_group_id_seq OWNER TO acsdba;

--
-- Name: auth_group_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: acsdba
--
...
ALTER TABLE public.auth_group_permissions OWNER TO acsdba;

--
-- Name: auth_group_permissions_id_seq; Type: SEQUENCE; Schema: public; Owner: acsdba
--
...
ALTER TABLE public.auth_group_permissions_id_seq OWNER TO acsdba;

--
-- Name: auth_group_permissions_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: acsdba
--
...
ALTER TABLE public.auth_permission OWNER TO acsdba;

--
-- Name: auth_permission_id_seq; Type: SEQUENCE; Schema: public; Owner: acsdba
--
...
ALTER TABLE public.auth_permission_id_seq OWNER TO acsdba;

--
-- Name: auth_permission_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: acsdba
--
...
ALTER TABLE public.auth_user OWNER TO acsdba;
...
ALTER TABLE public.auth_user_groups OWNER TO acsdba;

--
-- Name: auth_user_groups_id_seq; Type: SEQUENCE; Schema: public; Owner: acsdba
--
...
ALTER TABLE public.auth_user_groups_id_seq OWNER TO acsdba;

--
-- Name: auth_user_groups_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: acsdba
--
...
--
-- Name: auth_user_id_seq; Type: SEQUENCE; Schema: public; Owner: acsdba
--
...
ALTER TABLE public.auth_user_id_seq OWNER TO acsdba;

--
-- Name: auth_user_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: acsdba
--
...
ALTER TABLE public.auth_user_user_permissions OWNER TO acsdba;

--
-- Name: auth_user_user_permissions_id_seq; Type: SEQUENCE; Schema: public; Owner: acsdba
--
...
ALTER TABLE public.auth_user_user_permissions_id_seq OWNER TO acsdba;

--
-- Name: auth_user_user_permissions_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: acsdba
--
...
ALTER TABLE public.django_content_type OWNER TO acsdba;

--
-- Name: django_content_type_id_seq; Type: SEQUENCE; Schema: public; Owner: acsdba
--
...
ALTER TABLE public.django_content_type_id_seq OWNER TO acsdba;

--
-- Name: django_content_type_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: acsdba
--
...
ALTER TABLE public.django_migrations OWNER TO acsdba;

--
-- Name: django_migrations_id_seq; Type: SEQUENCE; Schema: public; Owner: acsdba
--
...
ALTER TABLE public.django_migrations_id_seq OWNER TO acsdba;

--
-- Name: django_migrations_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: acsdba
--
...
ALTER TABLE public.django_session OWNER TO acsdba;

--
-- Name: auth_group id; Type: DEFAULT; Schema: public; Owner: acsdba
--
...
--
-- Name: auth_group_permissions id; Type: DEFAULT; Schema: public; Owner: acsdba
--
...
--
-- Name: auth_permission id; Type: DEFAULT; Schema: public; Owner: acsdba
--
...
--
-- Name: auth_user id; Type: DEFAULT; Schema: public; Owner: acsdba
--
...
--
-- Name: auth_user_groups id; Type: DEFAULT; Schema: public; Owner: acsdba
--
...
--
-- Name: auth_user_user_permissions id; Type: DEFAULT; Schema: public; Owner: acsdba
--
...
--
-- Name: django_content_type id; Type: DEFAULT; Schema: public; Owner: acsdba
--
...
--
-- Name: django_migrations id; Type: DEFAULT; Schema: public; Owner: acsdba
--
...
--
-- Name: pdgs_user_preferences_pdgsuser pdgs_user_preferences_pdgsuser_key; Type: CONSTRAINT; Schema: public; Owner: acsdba
--

ALTER TABLE ONLY public.pdgs_user_preferences_pdgsuser
    ADD CONSTRAINT pdgs_user_preferences_pdgsuser_key UNIQUE (user_id);
...
--
-- Name: pdgs_user_preferences_pdgsuser pdgs_user_preferences_pdgsuser_pkey; Type: CONSTRAINT; Schema: public; Owner: acsdba
--
...
ALTER TABLE public.pdgs_user_preferences_pdgsuser
    ADD CONSTRAINT pdgs_user_preferences_pdgsuser_user_id_bb0a2048_fk_auth_user_id FOREIGN KEY (user_id) REFERENCES public.auth_user(id) DEFERRABLE INITIALLY DEFERRED;

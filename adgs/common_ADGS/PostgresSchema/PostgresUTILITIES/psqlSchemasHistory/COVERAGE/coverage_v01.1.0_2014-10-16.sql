...
/* ------------------------------
	t_cov_rules
*/ ------------------------------
ALTER TABLE t_cov_rules ADD fixedvaliditystart TIMESTAMP(6);
ALTER TABLE t_cov_rules ADD fixedvaliditystop TIMESTAMP(6);
...
---------------------------------- CONCLUSIONS ----------------------------------
---------------------------------------------------------------------------------
DELETE FROM t_schema WHERE version = 'coverage-1.1.0' ;
...
VALUES	(
		...
		25,
		'COVERAGE_1-1-0',
		'Added new fields on t_cov_rules. Changed procedure p_cov_periods_planner.'
) ;

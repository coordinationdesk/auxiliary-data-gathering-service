...
#	
#
#   $Prod: A.C.S. ZipS1ReformattedSafeFile script $
#
#	$Id$
#
#	$Author$
...
usage() {
	echo "usage: ZipS1ReformattedSafeFile <JobOrderFile>"
	echo "-------------------------------------------------------------------"
	echo ""
	exit 1
}
...
export LOG_FILE=$EXE_DIR/ZipS1ReformattedSafeFile.log
init_log
...
SAFE_FILE=`ls -d *.SAFE`
if test -z "$SAFE_FILE"; then res_msg 1 "*** ERROR!!! Reformatted file Not Found !!!"; fi

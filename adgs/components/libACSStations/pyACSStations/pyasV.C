/*
	...
	$Log$
	Revision 1.3  2007/02/27 18:05:45  marqua
	Creating new tag.
	
	Revision 1.2  2007/02/27 18:05:40  marqua
	proper versionfile handling
	
	Revision 1.1  2007/02/27 16:59:27  marqua
	proper versionfile handling
...
const char * pyasV::_name = "@(#) $Prod: A.C.S. pyACSStations $$Revision$$Date$" ;

const char* pyasV::_tag = "$Name$" ;

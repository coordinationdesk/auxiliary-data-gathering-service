...
{        
    ...
    #warning "ACS_SSL:: WARNING: DEBUG FORCED TO BE ALLOWED" ;
    ...
    #warning "ACS_SSL:: WARNING: DEBUG ALLOWED" ;
...
//
////////////////////////////////////////////////////////////
ACS_SSL::ACS_AES_handle::ACS_AES_handle(ACS_AES_Cipher cipher, const ACS_AES_Key& key_in, const ACS_AES_IV& iv, bool enc_oper, bool paddingSet) :
	_ctx(0), 
	_cipher(cipher),
	_blockLength(0),
	_keyLength(0),
	...
	_finalizedSet(false)
{
	...
	{
		case AES_128_CBC:
			{ getTypeFun = &EVP_aes_128_cbc ; break ; }
        case AES_192_CBC:
			{ getTypeFun = &EVP_aes_192_cbc ; break ; }
        case AES_256_CBC:
			{ getTypeFun = &EVP_aes_256_cbc ; break ; }
		default:
	...
	//	ACS_SSL::ACS_SSL_HexToString(iv, getBlockLength(cipher), dump, sizeof(dump)) ;
	//	excerr << "IV DUMP: " << dump << "  size: " << getBlockLength(cipher) << endl ;
	//}
...
//
////////////////////////////////////////////////////////////
size_t ACS_SSL::ACS_AES_handle::getKeyLength(ACS_AES_Cipher cipher)
{
	size_t keyLength = 0 ; 
    switch(cipher)
	{
		case AES_128_CBC: { keyLength = 16 ; break ; } // PRQA S 4400 3
        case AES_192_CBC: { keyLength = 24 ; break ; }
        case AES_256_CBC: { keyLength = 32 ; break ; }
...
//
////////////////////////////////////////////////////////////
size_t ACS_SSL::ACS_AES_handle::getBlockLength(ACS_AES_Cipher cipher)
{
	size_t blockLength = 0 ; 
    switch(cipher)
	{
		case AES_128_CBC: { blockLength = 16 ; break ; } // PRQA S 4400 3
        case AES_192_CBC: { blockLength = 16 ; break ; }
        case AES_256_CBC: { blockLength = 16 ; break ; }
		default: { ACS_THROW(ACS_SSL_InternalError("Cipher unsupported")); } // PRQA S 3081
	}
#ifdef ACS_SSL_HAS_DEBUG_ENABLED
									...
									vector <void*> &out_values) 	/* REF:  optional output parameters */ 
{
	...
	switch (al)
	{
		...
		case ENC_AES256CBC :
		{
			...
			const size_t block_length = ACS_SSL::ACS_AES_handle::getBlockLength(cipher) ;
			ACS_SSL::ACS_AES_IV iv_buffer ;
			memcpy(iv_buffer, in_values[1], block_length) ; 

 ...
 *
 *  Revision 1.11  2013/04/05 09:51:06  marpas
 ...
 *
 *  Revision 1.9  2012/05/23 14:04:14  micmaz
 *  updated key type
 *
 *  Revision 1.8  2012/05/23 10:58:25  micmaz
 ...
 *
 *  Revision 1.7  2012/05/22 10:02:25  micmaz
 *  IN PROGRESS - issue S1PDGS-3410: DS: Error in inserting a CirculationId with value greater than 32767
 *  http://jira.acsys.it/browse/S1PDGS-3410
 *
 *  Revision 1.6  2012/02/16 16:00:12  micmaz
...
// constructor
CirculationRemoveQueue::CirculationRemoveQueue(dbConnection &conn) : dbSmartPersistent(table(), conn)
{
}


// copy constructor
CirculationRemoveQueue::CirculationRemoveQueue(const CirculationRemoveQueue &o):
	dbSmartPersistent(o)
{
}


CirculationRemoveQueue::~CirculationRemoveQueue() throw()
{
}


// operator =
CirculationRemoveQueue &CirculationRemoveQueue::operator=(const CirculationRemoveQueue &o)
{
...
std::string CirculationRemoveQueue::str(dbConnection &conn, bool withId) const // PRQA S 4214
{
    std::ostringstream os;
    os << "{CirculationRemoveQueue";
    if (withId) {
        os << "@";
        os << getId();
    }
    bool null = false ;
    os << ", URL: " << getURL(null, conn);
    os << "}";
    return os.str();
}

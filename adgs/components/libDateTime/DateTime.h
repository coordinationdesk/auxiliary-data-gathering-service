...
public :
	...
	{
	public :
		explicit JD50(long double d = 0) throw() :_jd(d) { } 	
		JD50(const JD50 &r) : _jd(r._jd ) { }
		~JD50() throw() { }
		JD50 &operator=(const JD50 &r) throw() { if (this != &r) {_jd = r._jd ; } return *this ; }

		long double jd() const throw() { return _jd ; }
        long double jd50() const throw() { return _jd ; }
		JD50 &operator=(long double d) throw() { _jd = d ; return *this ; }
		operator long double() const throw() { return _jd ; }  // PRQA S 2181    
		JD50 & operator+=(const JD50 &r) throw() { _jd += r._jd ; return  *this ; }
		JD50 & operator-=(const JD50 &r) throw() { _jd -= r._jd ; return  *this ; }
	...
	public :
		...
		explicit JD70(long double d = 0) throw() :_jd(d) { } 	
		JD70(const JD70 &r) : _jd(r._jd ) { }
		~JD70() throw() { }
		JD70 &operator=(const JD70 &r) throw() { if (this != &r) {_jd = r._jd ; } return *this ; }
        
		long double jd() const throw() { return _jd ; }
        long double jd50() const throw() { return  _jd + _jd502jd70_OFFSET ; }
		JD70 &operator=(long double d) throw() { _jd = d ; return *this ; }
		operator long double() const throw() { return _jd ; }      // PRQA S 2181
		JD70 & operator+=(const JD70 &r) throw() { _jd += r._jd ; return  *this ; }
		JD70 & operator-=(const JD70 &r) throw() { _jd -= r._jd ; return  *this ; }
	...
	class JD {
	public :
		explicit JD(long double d = 0) throw() :_jd(d) { } 	
		JD(const JD &r) : _jd(r._jd ) { }
		~JD() throw() { }
		JD &operator=(const JD &r) throw() { if (this != &r) {_jd = r._jd ; } return *this ; }
        
		long double jd() const throw() { return _jd ; }
        long double jd50() const throw() { return _jd - _jd2jd50_OFFSET ; }

		JD &operator=(long double d) throw() { _jd = d ; return *this ; }
		operator long double() const throw() { return _jd ; }      // PRQA S 2181
		JD & operator+=(const JD &r) throw() { _jd += r._jd ; return  *this ; }
		JD & operator-=(const JD &r) throw() { _jd -= r._jd ; return  *this ; }
...
///////////////////	
	...
	public :
		...
		explicit MJD2000(long double d = 0) throw() :_jd(d) { } 	
		MJD2000(const MJD2000 &r) : _jd(r._jd ) { }
		~MJD2000() throw() { }
		MJD2000 &operator=(const MJD2000 &r) throw() { if (this != &r) {_jd = r._jd ; } return *this ; }
        
		long double jd() const throw() { return _jd ; }
		long double jd50() const throw() { return _jd + MJD2000::_jd502mjd2000_OFFSET; }

		MJD2000 &operator=(long double d) throw() { _jd = d ; return *this ; }
		operator long double() const throw() { return _jd ; }      // PRQA S 2181
	...
	public :
		...
		explicit MJD(long double d = 0) throw() :_jd(d) { } 	
		MJD(const MJD &r) : _jd(r._jd ) { }
		~MJD() throw() { }
		MJD &operator=(const MJD &r) throw() { if (this != &r) {_jd = r._jd ; } return *this ; }
        
		long double jd() const throw() { return _jd ; }
		long double jd50() const throw() { return _jd - MJD::_jd502mjd_OFFSET; }

		MJD &operator=(long double d) throw() { _jd = d ; return *this ; }
		operator long double() const throw() { return _jd ; }      // PRQA S 2181
	...
	public :
		...
		UTCD & operator=(const UTCD &r) throw() 
        {
	        // the standard assignement operator 
	        // implementation
	        if (this != &r) {
		        year = r.year ;
		        month = r.month ;
		...
		bool isValid(bool genException = 0) const ;
		...
		unsigned long microsec() const throw() { return convertDigits (frac, _ndigits, 6); } // PRQA S 3000, 3011, 3084, 4400 3
		unsigned long millisec() const throw() { return convertDigits (frac, _ndigits, 3); }
		unsigned long nanosec() const throw() {  return convertDigits (frac, _ndigits, 9); }
		void microsec(unsigned long) ;
		void millisec(unsigned long) ;
		void nanosec(unsigned long) ;
        long double jd50() const ;
	...
	explicit DateTime(bool) throw() : jd50_(), _filled(false) {}
	DateTime() throw() ;                // build a time with the actual time
	explicit DateTime(time_t t) throw() : jd50_(JD70(t/86400.0L).jd50()), _filled(true) {} // PRQA S 3011, 3081, 4400

	explicit DateTime(const boost::posix_time::ptime &) throw() ;

    // PRQA S 2180 9
	DateTime(const  JD50 &jd50) throw() : jd50_(jd50.jd()), _filled(true) {	}
	DateTime(const  JD70 &jd70) throw() : jd50_(jd70.jd50()), _filled(true) { }
	DateTime(const  JD &jd) throw() : jd50_(jd.jd50()), _filled(true) { }
	DateTime(const  MJD2000 &jd2000) throw() : jd50_(jd2000.jd50()), _filled(true) { }
	DateTime(const  MJD &mjd) throw() : jd50_(mjd.jd50()), _filled(true) { }
	DateTime(const UTCD &u) throw() : jd50_(u.jd50()), _filled(true) { }
	DateTime(const std::string &s) : jd50_(), _filled(false) { *this = s ; }
	DateTime(const char *s) : jd50_(), _filled(false) { *this = std::string(s) ; } // PRQA S 3081

	~DateTime() throw() {}
	
	DateTime(const DateTime &r) throw() : jd50_(r.jd50_), _filled(r._filled) {}
	DateTime &operator=(const DateTime &r) throw() {
        if (this != &r) {
		    _filled = r._filled ;
		    jd50_ = r.jd50_ ;
        }
    ...
    void assertIsFilled() const { ACS_COND_THROW(not isFilled(), exIllegalValueException("Not filled") ) ; } // PRQA S 3081 
    ...
    {
	    ACS_COND_THROW(not isFilled() || not t.isFilled(), exIllegalValueException("Both args must be filled")) ; // PRQA S 3081
	...
	/** returns in the range [1,12] the number of the month
	     ...
	     case are ignored
	 */
	static int	month2Num(const std::string &) ;	
	 ...
	 */
	tm DateTime2tm(long *ns = 0) const ;
	
	/**
	 *	returns UTC absolute time (do not uses TZ)
	 */
 	time_t Datetime2time_t(long *ns = 0) const ;
	...
	long double jd50() const throw() { return jd50_ ; }
	 ...
	 */
    unsigned short int toGpsWeek() const { assertIsFilled() ;
        return static_cast<unsigned short int>( (jd50() - 10962.0 )/7.0 ) ; /* JD50 to GPS WEEK */ // PRQA S 3081, 4400
    }
    ...
    // PRQA S 2181 7
    operator UTCD() const { UTCD u ; toUTCD(u) ; return u ; }
	operator JD50() const { assertIsFilled() ; return JD50(jd50()) ; } // PRQA S 3081
	operator JD70() const { assertIsFilled() ; return JD70(jd50() - JD70::_jd502jd70_OFFSET) ; } // PRQA S 3081
	operator JD() const { assertIsFilled() ; return JD(jd50() + JD::_jd2jd50_OFFSET) ; } // PRQA S 3081
	operator MJD2000() const { assertIsFilled() ; return  MJD2000(jd50() - MJD2000::_jd502mjd2000_OFFSET) ; } // PRQA S 3081
	operator MJD() const { assertIsFilled() ; return  MJD(jd50() + MJD::_jd502mjd_OFFSET) ; } // PRQA S 3081
	...
	DateTime &operator=(const UTCD &u) throw() { jd50_ = u.jd50() ;	_filled = true ; return *this ; }
	DateTime &operator=(const JD50 &jd50) throw() { jd50_ = jd50.jd50() ; _filled = true ; return *this ; }
	DateTime &operator=(const JD70 &jd70) throw() { jd50_ = jd70.jd50() ; _filled = true ; return *this ; }
	DateTime &operator=(const JD &jd) throw() { jd50_ = jd.jd50() ;	_filled = true ; return *this ; }
	DateTime &operator=(const MJD2000 &jd2000) throw() { jd50_ = jd2000.jd50() ; _filled = true ; return *this ; }
	DateTime &operator=(const MJD &mjd) throw() { jd50_ = mjd.jd50() ; _filled = true ; return *this ; }

	bool isFilled() const throw() { return _filled ; }
	void reset() throw() { _filled = false ; }
	long double diffDay(const DateTime &d) const throw() {  return jd50_ - d.jd50_ ; }
    ...
    static const std::string &unfilledDate() throw() ;
// data section
private:
	long double jd50_ ; 
 ...
 * 
 * arguments to be intended as days floating point */
inline const DateTime operator+(const DateTime &d, long double days) // PRQA S 2134
{
...
inline bool operator>(const DateTime::JD50 &a, const DateTime::JD50 &b) throw() { return a.jd() > b.jd() ; } // PRQA S 2134 EOF
inline bool operator>=(const DateTime::JD50 &a, const DateTime::JD50 &b) throw() { return a.jd() >= b.jd() ; }
inline bool operator<=(const DateTime::JD50 &a, const DateTime::JD50 &b) throw() { return not (a > b) ; }
inline bool operator<(const DateTime::JD50 &a, const DateTime::JD50 &b) throw() { return not (a >= b) ; }
inline bool operator==(const DateTime::JD50 &a, const DateTime::JD50 &b) throw() { return not (a < b) && not (a > b) ; }
inline bool operator!=(const DateTime::JD50 &a, const DateTime::JD50 &b) throw() { return not (a == b) ; }


inline bool operator>(const DateTime::JD70 &a, const DateTime::JD70 &b) throw() { return a.jd() > b.jd() ; }
inline bool operator>=(const DateTime::JD70 &a, const DateTime::JD70 &b) throw() { return a.jd() >= b.jd() ; }
inline bool operator<=(const DateTime::JD70 &a, const DateTime::JD70 &b) throw() { return not (a > b) ; }
inline bool operator<(const DateTime::JD70 &a, const DateTime::JD70 &b) throw() { return not (a >= b) ; }
inline bool operator==(const DateTime::JD70 &a, const DateTime::JD70 &b) throw() { return not (a < b) && not (a > b) ; }
inline bool operator!=(const DateTime::JD70 &a, const DateTime::JD70 &b) throw() { return not (a == b) ; }

inline bool operator>(const DateTime::JD &a, const DateTime::JD &b) throw() { return a.jd() > b.jd() ; }
inline bool operator>=(const DateTime::JD &a, const DateTime::JD &b) throw() { return a.jd() >= b.jd() ; }
inline bool operator<=(const DateTime::JD &a, const DateTime::JD &b) throw() { return not (a > b) ; }
inline bool operator<(const DateTime::JD &a, const DateTime::JD &b) throw() { return not (a >= b) ; }
inline bool operator==(const DateTime::JD &a, const DateTime::JD &b) throw() { return not (a < b) && not (a > b) ; }
inline bool operator!=(const DateTime::JD &a, const DateTime::JD &b) throw() { return not (a == b) ; }

inline bool operator>(const DateTime::MJD2000 &a, const DateTime::MJD2000 &b) throw() { return a.jd() > b.jd() ; }
inline bool operator>=(const DateTime::MJD2000 &a, const DateTime::MJD2000 &b) throw() { return a.jd() >= b.jd() ; }
inline bool operator<=(const DateTime::MJD2000 &a, const DateTime::MJD2000 &b) throw() { return not (a > b) ; }
inline bool operator<(const DateTime::MJD2000 &a, const DateTime::MJD2000 &b) throw() { return not (a >= b) ; }
inline bool operator==(const DateTime::MJD2000 &a, const DateTime::MJD2000 &b) throw() { return not (a < b) && not (a > b) ; }
inline bool operator!=(const DateTime::MJD2000 &a, const DateTime::MJD2000 &b) throw() { return not (a == b) ; }

inline bool operator>(const DateTime::MJD &a, const DateTime::MJD &b) throw() { return a.jd() > b.jd() ; }
inline bool operator>=(const DateTime::MJD &a, const DateTime::MJD &b) throw() { return a.jd() >= b.jd() ; }
inline bool operator<=(const DateTime::MJD &a, const DateTime::MJD &b) throw() { return not (a > b) ; }
inline bool operator<(const DateTime::MJD &a, const DateTime::MJD &b) throw() { return not (a >= b) ; }
inline bool operator==(const DateTime::MJD &a, const DateTime::MJD &b) throw() { return not (a < b) && not (a > b) ; }
inline bool operator!=(const DateTime::MJD &a, const DateTime::MJD &b) throw() { return not (a == b) ; }
...
inline bool operator>=(const DateTime &a, const DateTime &b) { return a.jd50() >= b.jd50() ; }
inline bool operator<=(const DateTime &a, const DateTime &b) { return a.jd50() <= b.jd50() ; }
inline bool operator==(const DateTime &a, const DateTime &b) throw() // PRQA S 4020
{
...
inline bool operator!=(const DateTime &a, const DateTime &b) throw() { return not (a == b) ; }

...
public:
	...
	enum IntervalClosure { OpenInterval, LeftClosedInterval, RightClosedIntrval, ClosedInterval } ;
...
public:
	static int getDebugLevel() { return exCDebugLevel.getDebug() ; }
...
inline bool operator!=(const TimeRange& a, const TimeRange &b) { return not (a == b) ; } // PRQA S 2134

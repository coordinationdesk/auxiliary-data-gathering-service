...
class VariableDateTime // PRQA S 2109
{
	public:
		...
		__attribute__((deprecated)) VariableDateTime() throw() ;
		explicit __attribute__((deprecated)) VariableDateTime(std::string const &);
		__attribute__((deprecated)) VariableDateTime(VariableDateTime const&) throw() ;
		__attribute__((deprecated)) VariableDateTime &operator=(VariableDateTime const&) throw() ;
		~VariableDateTime() throw() ;

...
public:
	virtual ~OriginatorName() throw() {}  // PRQA S 2131
...
private:
	OriginatorName &operator=(const OriginatorName &) ;	// declared but not implemented
	OriginatorName (const OriginatorName &) ; 			// declared but not implemented
	OriginatorName () ; 								// declared but not implemented
} ; 

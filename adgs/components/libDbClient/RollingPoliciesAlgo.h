...
public:
	virtual ~RollingPoliciesAlgo() throw() {}  // PRQA S 2131
...
private:
	RollingPoliciesAlgo &operator=(const RollingPoliciesAlgo &) ; 	// declared but not implemented
	RollingPoliciesAlgo (const RollingPoliciesAlgo &) ; 			// declared but not implemented
	RollingPoliciesAlgo () ; 									// declared but not implemented
} ; 

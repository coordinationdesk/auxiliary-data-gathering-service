...
SQLDialectAppSpecific::SQLDialectAppSpecific() {}
SQLDialectAppSpecific::~SQLDialectAppSpecific() throw() {}
...
map <string, DBXSH_PTR_NSPACE::shared_ptr<Plugin> > SQLDialectFactory::_dialectPlugin ;
...
SQLDialectFactory::~SQLDialectFactory() throw()
{
// PRQA S 4631 9
...
void SQLDialectFactory::initPlugin(const string &key, const string &so_path, const string &dialect) 
{
	...
	_dialectPlugin[key] = DBXSH_PTR_NSPACE::shared_ptr<Plugin>(new Plugin(so_path)) ; // PRQA S 3081

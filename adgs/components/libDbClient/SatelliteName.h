...
public:
	virtual ~SatelliteName() throw() {}  // PRQA S 2131
...
private:
	SatelliteName &operator=(const SatelliteName &) ; 	// declared but not implemented
	SatelliteName (const SatelliteName &) ; 			// declared but not implemented
	SatelliteName () ; 									// declared but not implemented
} ; 

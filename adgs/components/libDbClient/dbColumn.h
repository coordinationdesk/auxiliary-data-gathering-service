...
public:	
	...
	*/
#ifndef ACS_DBCLIENT_PREVENT_DEFAULTKEY
	explicit dbColumn(dbSpecificColumnType::Type t, bool isNull=true) ;
#endif
...
#ifndef ACS_DBCLIENT_PREVENT_DEFAULTKEY
	template<typename T>
	dbColumn(T const & value,  bool isNull) ;
#endif
	template<typename T>
...
#ifndef ACS_DBCLIENT_PREVENT_DEFAULTKEY
	dbColumn(void* value, bool isNull);
#endif
...
private:
	...
	class Value {
		public:
			...
			virtual ~Value() throw() {} // PRQA S 2131
	...
	public:
		...
		virtual ~GeoValue() throw() { delete _value ; }
...
template<typename T> 
inline
dbColumn::dbColumn(T const & value,  bool isNull) :
    _type(),
	_key(""), 
	_value(0)
{
...
template<typename T> 
inline dbColumn::ValueInst<T>::~ValueInst() throw() {}

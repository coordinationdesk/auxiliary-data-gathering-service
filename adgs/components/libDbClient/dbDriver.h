...
private:
	...
	dbDriver() ; // not implemented
	dbDriver(const dbDriver &) ; // not implemented
	dbDriver& operator=(const dbDriver &) ; // not implemented
...
private:
	...
	std::unique_ptr<Plugin> _so_loader ;
#else
	std::auto_ptr<Plugin> _so_loader ;
#endif

...
/*
	...
	Revision 2.4  2013/02/06 16:02:41  marpas
	...
	Revision 2.2  2009/05/13 14:45:26  marpas
	rules fixing
...
#ifndef _AeolusFixedHeaderFactory_H_
#define _AeolusFixedHeaderFactory_H_
...
class AeolusFixedHeaderFactory : public dbFixedHeaderFactory {

public:
	AeolusFixedHeaderFactory() ;
	virtual ~AeolusFixedHeaderFactory()  throw() ;
...
private:
	...
	AeolusFixedHeaderFactory(const AeolusFixedHeaderFactory & ) ;
	AeolusFixedHeaderFactory &operator=(const AeolusFixedHeaderFactory & ) ;
} ;
...
#endif // _AeolusFixedHeaderFactory_H_

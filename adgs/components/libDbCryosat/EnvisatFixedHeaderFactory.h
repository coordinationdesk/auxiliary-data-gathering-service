...
#ifndef _EnvisatFixedHeaderFactory_H_
#define _EnvisatFixedHeaderFactory_H_
...
class EnvisatFixedHeaderFactory : public dbFixedHeaderFactory {
public:
	EnvisatFixedHeaderFactory() ;
	virtual ~EnvisatFixedHeaderFactory() throw() ;
...
private:
	...
	EnvisatFixedHeaderFactory(const EnvisatFixedHeaderFactory & ) ;
	EnvisatFixedHeaderFactory &operator=(const EnvisatFixedHeaderFactory & ) ;
} ;


_ACS_END_NAMESPACE

#endif // _EnvisatFixedHeaderFactory_H_

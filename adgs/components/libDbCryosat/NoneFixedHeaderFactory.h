...
/*
	...
	Revision 2.1  2009/05/13 14:45:27  marpas
	rules fixing
...
#ifndef _NoneFixedHeaderFactory_H_
#define _NoneFixedHeaderFactory_H_
...
class NoneFixedHeaderFactory : public dbFixedHeaderFactory {

public:
	NoneFixedHeaderFactory() ;
	virtual ~NoneFixedHeaderFactory() throw() ;
...
private:
	...
	NoneFixedHeaderFactory(const NoneFixedHeaderFactory & ) ;
	NoneFixedHeaderFactory &operator=(const NoneFixedHeaderFactory & ) ;
} ;
...
#endif // _NoneFixedHeaderFactory_H_

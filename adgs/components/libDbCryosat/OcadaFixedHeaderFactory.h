...
/*
	...
	Revision 1.4  2013/02/06 16:02:42  marpas
	coding best practices applied
	exception simplified
	qa rules
	
	Revision 1.3  2012/02/14 12:52:44  marpas
	 refactoring and introducing dbInventory::uniqueId
	
	Revision 1.2  2009/05/13 14:45:27  marpas
	rules fixing
...
#ifndef _OcadaFixedHeaderFactory_H_
#define _OcadaFixedHeaderFactory_H_
...
class OcadaFixedHeaderFactory : public dbFixedHeaderFactory {

public:
	OcadaFixedHeaderFactory() ;
	virtual ~OcadaFixedHeaderFactory() throw() ;
...
private:
	...
	OcadaFixedHeaderFactory(const OcadaFixedHeaderFactory & ) ;
	OcadaFixedHeaderFactory &operator=(const OcadaFixedHeaderFactory & ) ;
} ;


_ACS_END_NAMESPACE

#endif // _OcadaFixedHeaderFactory_H_

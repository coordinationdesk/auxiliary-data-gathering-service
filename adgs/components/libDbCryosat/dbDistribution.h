...
/*
	...
	Revision 2.6  2013/02/07 15:04:23  enrcar
	...
	Revision 1.21  2005/06/17 10:31:54  marpas
	...
	Revision 1.18  2004/04/19 13:38:43  paoscu
	Field "format" added.
...
#ifndef _dbDistribution_H_
#define _dbDistribution_H_
...
//
//
// class dbDistribution
//
//
//
class dbDistribution : // PRQA S 2109, 2153
	public dbPersistent
{
	friend class dbCryosatFactory ; // PRQA S 2107
public:

	virtual ~dbDistribution() throw() ;
	dbDistribution &operator=(const dbDistribution &) ; // operator =
	...
	const int &getFormat(bool *set=0) const ;
...
protected:
	dbDistribution() ;
	dbDistribution(const dbDistribution &) ;
...
private:
	...
	ACS_CLASS_DECLARE_DEBUG_LEVEL(dbDistribution)
} ;


_ACS_END_NAMESPACE

#endif // _dbDistribution_H_

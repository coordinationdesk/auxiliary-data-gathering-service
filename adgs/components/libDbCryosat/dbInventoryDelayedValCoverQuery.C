...
dbInventoryDelayedValCoverQuery::dbInventoryDelayedValCoverQuery(bool latest, const string &dbKey)
: dbInventoryDelayedValCoverOrIntersectQuery(latest , false, dbKey)
{
}


dbInventoryDelayedValCoverQuery::dbInventoryDelayedValCoverQuery(dbInventoryDelayedValCoverQuery const &r)
: dbInventoryDelayedValCoverOrIntersectQuery(r) // these will be override by assignement
{
}

dbInventoryDelayedValCoverQuery &dbInventoryDelayedValCoverQuery::operator=(dbInventoryDelayedValCoverQuery const &r)
{
    if (this != &r) {
...
dbInventoryDelayedValCoverQuery::~dbInventoryDelayedValCoverQuery() throw() {}

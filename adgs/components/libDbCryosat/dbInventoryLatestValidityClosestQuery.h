...
#ifndef _dbInventoryLatestValidityClosestQuery_H_
#define _dbInventoryLatestValidityClosestQuery_H_
...
class dbInventoryLatestValidityClosestQuery : // PRQA S 2109, 2153
	public dbInventoryObjectSpecialQuery
{
	friend class dbCryosatFactory ; // PRQA S 2107
public:

	dbInventoryLatestValidityClosestQuery(dbInventoryLatestValidityClosestQuery const &) ;
	dbInventoryLatestValidityClosestQuery &operator=(dbInventoryLatestValidityClosestQuery const &) ;
	...
	virtual ~dbInventoryLatestValidityClosestQuery() throw() ;

	virtual unsigned long doQuery(dbConnection &, bool incremental=false, bool enabled = true)  ; 


protected:
	explicit dbInventoryLatestValidityClosestQuery(const std::string &dbkey);

private:
	dbInventoryLatestValidityClosestQuery(); // not implemented


private:
	ACS_CLASS_DECLARE_DEBUG_LEVEL(dbInventoryLatestValidityClosestQuery)
...
#endif // _dbInventoryLatestValidityClosestQuery_H_

...
/*
	...
	Revision 5.4  2016/07/04 15:03:57  damdec
	...
	Revision 2.6  2013/04/30 13:31:42  marpas
	dbPersistent interface changed
	
	Revision 2.5  2013/04/17 17:37:24  marpas
	dbPersistent interface changed
	...
	Revision 2.3  2012/11/19 22:51:15  marpas
	...
	Revision 2.1  2011/09/28 13:29:39  lucia.galli
	...
	Revision 2.3  2008/12/16 18:48:43  paoscu
	 Implemented dbInventoryTDIMultiBandValCoverOrIntersectQuery
	
	Revision 2.2  2008/12/16 15:59:33  marpas
	 work in progress
	
	Revision 2.1  2008/12/03 18:09:03  paoscu
	dbInventoryMultiBandValCoverOrIntersectQuery Added
	
	Revision 2.1  2008/12/01 20:07:05  paoscu
	Added dbInventoryMultiBandValCoverOrIntersectQuery
...
dbInventoryMultiBandValCoverOrIntersectQuery::dbInventoryMultiBandValCoverOrIntersectQuery(bool latest, bool intersect, const string &dbKey)
...
dbInventoryMultiBandValCoverOrIntersectQuery::dbInventoryMultiBandValCoverOrIntersectQuery(dbInventoryMultiBandValCoverOrIntersectQuery const &r)
: dbInventoryValCoverOrIntersectQuery(r) // these will be override by assignement
{
}

dbInventoryMultiBandValCoverOrIntersectQuery &dbInventoryMultiBandValCoverOrIntersectQuery::operator=(dbInventoryMultiBandValCoverOrIntersectQuery const &r)
{
    if (this != &r) {
...
dbInventoryMultiBandValCoverOrIntersectQuery::~dbInventoryMultiBandValCoverOrIntersectQuery() throw()
{
}



unsigned long dbInventoryMultiBandValCoverOrIntersectQuery::doQuery(dbConnection &c, bool incremental, bool enabled)
{
	if( ! incremental) {
		clear() ;
    }
	...
	try
	{
		...
		for(size_t b=0 ; b<bq_size ; ++b)
		{
			...
			dbInventoryValCoverOrIntersectQuery::doQuery( c, true, enabled ) ; //force incremental
...
bool dbInventoryMultiBandValCoverOrIntersectQuery::doesOverlap() const
{

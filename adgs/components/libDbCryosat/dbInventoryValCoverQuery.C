...
/*
	...
	Revision 1.16  2005/06/17 10:31:54  marpas
	...
	Revision 1.12  2004/12/30 22:47:59  paoscu
	headers fixed
	
	Revision 1.11  2004/10/19 14:19:14  ivafam
...
dbInventoryValCoverQuery::dbInventoryValCoverQuery(bool latest, const string &dbKey)
: dbInventoryValCoverOrIntersectQuery(latest , false, dbKey)
{
}


dbInventoryValCoverQuery::dbInventoryValCoverQuery(dbInventoryValCoverQuery const &r)
: dbInventoryValCoverOrIntersectQuery(r) 
{
}

dbInventoryValCoverQuery &dbInventoryValCoverQuery::operator=(dbInventoryValCoverQuery const &r)
{
    if (this != &r) {
...
dbInventoryValCoverQuery::~dbInventoryValCoverQuery() throw() {}

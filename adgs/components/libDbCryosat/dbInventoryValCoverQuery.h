...
/*
	...
	Revision 1.5  2004/04/28 13:08:40  paoscu
...
#ifndef _dbInventoryValCoverQuery_H_
#define _dbInventoryValCoverQuery_H_
...
class dbInventoryValCoverQuery : // PRQA S 2153
	public dbInventoryValCoverOrIntersectQuery
{
	friend class dbCryosatFactory ; // PRQA S 2107
public:

	dbInventoryValCoverQuery(dbInventoryValCoverQuery const &) ;
	dbInventoryValCoverQuery &operator=(dbInventoryValCoverQuery const &) ;
	virtual ~dbInventoryValCoverQuery() throw() ;
	
protected:
	dbInventoryValCoverQuery(bool latest, const std::string &dbKey);
private:
	dbInventoryValCoverQuery() ; // declared but not implemented
...
#endif // _dbInventoryValCoverQuery_H_

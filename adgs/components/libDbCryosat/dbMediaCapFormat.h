...
#ifndef _dbMediaCapFormat_H_
#define _dbMediaCapFormat_H_
...
//
//
class dbMediaCapFormat : // PRQA S 2109, 2153
	public dbPersistent
{
	friend class dbCryosatFactory ; // PRQA S 2107
public:

	virtual ~dbMediaCapFormat() throw() ;
	dbMediaCapFormat &operator=(const dbMediaCapFormat &) ; // operator =
	...
	float getMultiplier(bool *set=0) const ;
...
protected:
	dbMediaCapFormat() ;
	dbMediaCapFormat(const dbMediaCapFormat &) ;
...
private:
	...
	ACS_CLASS_DECLARE_DEBUG_LEVEL(dbMediaCapFormat)
} ;


_ACS_END_NAMESPACE

#endif // _dbMediaCapFormat_H_

...
/*
	...
	$Log$
	Revision 6.1  2016/07/26 10:10:08  damdec
	...
	Revision 5.1  2015/06/09 13:06:35  marpas
	qa warning removed
	...
	Revision 2.5  2013/03/29 19:51:30  marpas
...
public:
	...
	virtual ~dbProcessor() throw() ;
	dbProcessor &operator=(const dbProcessor &) ; // operator =
	...
	void setBaseline(const std::string &) ;
	const std::string &getBaseline(bool *set=0) const ;
	void unsetBaseline();
...
private:
	...
	ACS_CLASS_DECLARE_DEBUG_LEVEL(dbProcessor)

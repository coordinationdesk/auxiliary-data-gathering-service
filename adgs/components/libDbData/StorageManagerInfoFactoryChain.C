...
StorageManagerInfoFactoryChain::~StorageManagerInfoFactoryChain() throw() {}
...
void StorageManagerInfoFactoryChain::unregisterFactory(StorageManagerInfoFactory *f) throw() 
{

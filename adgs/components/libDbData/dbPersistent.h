...
public:
	...
	private:
		//Not implemented
		dbPersistentMemento() ;
		dbPersistentMemento(dbPersistentMemento const &) ;
		dbPersistentMemento& operator=(dbMemento const &) ;
		dbPersistentMemento& operator=(dbPersistentMemento const &) ;
	private:
		IdType  _id ; 
		bool	_modified ;
		bool	_fromDatabase ;	
...
protected:	
	...
	dbPersistent(dbPersistent&&) noexcept ; // move constructor
	dbPersistent &operator=(dbPersistent &&) noexcept ;
public:	

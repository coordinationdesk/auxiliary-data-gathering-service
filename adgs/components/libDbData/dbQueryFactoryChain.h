...
public:
	...
	virtual ~dbQueryFactoryChain() throw() ;	
...
private:
	dbQueryFactoryChain(const dbQueryFactoryChain &); // declared but not implemented
	dbQueryFactoryChain &operator=(const dbQueryFactoryChain &); // declared but not implemented

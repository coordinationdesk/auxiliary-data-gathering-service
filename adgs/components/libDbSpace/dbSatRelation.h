...
#ifndef _dbSatRelation_H_
#define _dbSatRelation_H_
...
public:
	...
	virtual ~dbSatRelation() throw() ;
	dbSatRelation &operator=(const dbSatRelation &) ; // operator =
...
protected:
	dbSatRelation() ;
	dbSatRelation(const dbSatRelation &) ;
...
private:
	...
	ACS_CLASS_DECLARE_DEBUG_LEVEL(dbSatRelation)
} ;


_ACS_END_NAMESPACE //acs

#endif // _dbSatRelation_H_

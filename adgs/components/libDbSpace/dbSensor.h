...
public:
	...
	virtual ~dbSensor() throw() ;
	dbSensor &operator=(const dbSensor &) ; // operator =
	...
	void setSensorName(const std::string &) ;
	const std::string &getSensorName(bool *set=0) const ;
	void unsetSensorName();
...
private:
	...
	ACS_CLASS_DECLARE_DEBUG_LEVEL(dbSensor)
} ;

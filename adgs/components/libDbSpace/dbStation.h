/*
	...
	$Log$
	Revision 1.26  2016/04/11 13:26:34  marpas
	...
	Revision 1.17  2011/03/02 18:00:10  marpas
	serial 8 support
...
#ifndef _dbStation_H_
#define _dbStation_H_
...
public:
	...
	virtual ~dbStation() throw() ;
	dbStation &operator=(const dbStation &) ; // operator =
	...
	int getStationId(bool *set=0) const ;
	void unsetStationId();

	void setStationName(const std::string &) ;
	const std::string &getStationName(bool *set=0) const ;
	void unsetStationName();

	void setStationAcronym(const std::string &) ;
	const std::string &getStationAcronym(bool *set=0) const ;
	void unsetStationAcronym();
...
private:
	...
	bool _stationNameSet ;

	std::string _stationAcronym ;
	bool _stationAcronymSet ;

	ACS_CLASS_DECLARE_DEBUG_LEVEL(dbStation)
} ;

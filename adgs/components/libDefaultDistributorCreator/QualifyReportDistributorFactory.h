...
#ifndef _QualifyReportDistributorFactory_H_
#define _QualifyReportDistributorFactory_H_ 
...
class QualifyReportDistributorFactory : public DistributorCreatorFactory // PRQA S 2109
{	

public:

	QualifyReportDistributorFactory() ;
	virtual ~QualifyReportDistributorFactory() throw() ;
...
private:
	...
	QualifyReportDistributorFactory(const QualifyReportDistributorFactory &) ;
	QualifyReportDistributorFactory &operator=(const QualifyReportDistributorFactory &) ; 
	
private:
	ACS_CLASS_DECLARE_DEBUG_LEVEL(QualifyReportDistributorFactory) ;
} ;

_ACS_END_NAMESPACE

#endif /* _QualifyReportDistributorFactory_H_ */

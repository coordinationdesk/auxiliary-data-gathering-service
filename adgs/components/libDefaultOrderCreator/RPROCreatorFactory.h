...
#ifndef _RPROCreatorFactory_H_
#define _RPROCreatorFactory_H_ 
...
class RPROCreatorFactory : public OrderCreatorFactory // PRQA S 2109
{	

public:

	RPROCreatorFactory() ;
	virtual ~RPROCreatorFactory() throw() ;
...
private:
	...
	RPROCreatorFactory(const RPROCreatorFactory &) ;
	RPROCreatorFactory &operator=(const RPROCreatorFactory &) ; 
	
private:
	ACS_CLASS_DECLARE_DEBUG_LEVEL(RPROCreatorFactory) ;
} ;

_ACS_END_NAMESPACE


#endif /* _RPROCreatorFactory_H_ */

...
// PRQA S 0040 EOF # warning directive were not recognized by PRQA
// PRQA S 2428 EOF # this file uses char 
...
namespace { //unnamed
    ...
    {
        static std::string basedir="" ; // PRQA S 2328 EOF # the static run time initialization is foreseen for the whole file
        if (0 == basedir.length()) { // PRQA S 3143
            char dir_[acs::os::ProcessStatus::instance()->getExeDir().length()+1] ; // PRQA S 0154, 2410, 3084, 3143, 4403, 4636
            strcpy(dir_, acs::os::ProcessStatus::instance()->getExeDir().c_str()) ; // PRQA S 2839, 3228, 3840, 4636 2
            basedir = std::string(dirname(dir_)) ; // PRQA S 3081, 3234
        }
        return basedir + r ;
    }
#endif
...
char const * defaultAcsPath() ACS_NOEXCEPT 
{
    ...
    static char const * const _defAcsPath = strdup(get_rel_path("").c_str()) ; // PRQA S 2706
#else
    ...
    static char const * const _defAcsPath = DEFAULT_ACS_PATH ; // PRQA S 1021
#endif
    return _defAcsPath ;
...
char const * defaultConfPath() ACS_NOEXCEPT 
{
    ...
    static char const * const _defConfPath = strdup(get_rel_path(DEFAULT_ACS_CONF_PATH).c_str()) ; // PRQA S 1021, 2706
 #else
    static char const * const _defConfPath = strdup(get_rel_path("/conf").c_str()) ;  // PRQA S 2706
 #endif
#else
    ...
    static char const * const _defConfPath = DEFAULT_ACS_CONF_PATH ; // PRQA S 1021
 #else
    static char const * const _defConfPath = DEFAULT_ACS_PATH "/conf" ; // PRQA S 1021
 #endif
#endif
    return _defConfPath ;
}
...
char const * defaultOptConfPath() ACS_NOEXCEPT 
{
    ...
    static char const * const _defOptConfPath = strdup(get_rel_path(DEFAULT_ACS_OPT_CONF_PATH).c_str()) ; // PRQA S 1021, 2706
 #else
    static char const * const _defOptConfPath = strdup(get_rel_path("/conf_opt").c_str()) ; // PRQA S 2328, 2706
 #endif
#else
    ...
    static char const * const _defOptConfPath = DEFAULT_ACS_OPT_CONF_PATH ; // PRQA S 1021
 #else
    static char const * const _defOptConfPath = DEFAULT_ACS_PATH "/conf_opt" ; // PRQA S 1021
 #endif
#endif
...
char const * defaultDbConfPath() ACS_NOEXCEPT 
{
    ...
    static char const * const _defDbConfPath = strdup(get_rel_path(DEFAULT_ACS_DBCONF_PATH).c_str()) ; // PRQA S 1021, 2706
 #else
    static char const * const _defDbConfPath = strdup(get_rel_path("/conf/database").c_str()) ; // PRQA S 2706
 #endif
#else
    ...
    static char const * const _defDbConfPath = DEFAULT_ACS_DBCONF_PATH ; // PRQA S 1021
 #else
    static char const * const _defDbConfPath = DEFAULT_ACS_PATH "/conf/database" ; // PRQA S 1021
 #endif
#endif
...
char const * defaultDbConfFileName() ACS_NOEXCEPT 
{
    ...
    // hence cannot be declared as a const std::string ;
    static char const * const _defDbConfFileName = DEFAULT_ACS_DBCONF_FILENAME ; // PRQA S 1021
...
char const * defaultDebugPath() ACS_NOEXCEPT 
{
   ...
   #warning DEFAULT_ACS_DEBUG_PATH overrides the relative default debug path
    static char const * const _defDebugPath = strdup(get_rel_path(DEFAULT_ACS_DEBUG_PATH).c_str()) ; // PRQA S 1021, 2706
 #else
    static char const * const _defDebugPath = strdup(get_rel_path("/debug").c_str()) ; // PRQA S 2706
 #endif
#else
    ...
    static char const * const _defDebugPath = DEFAULT_ACS_DEBUG_PATH ; // PRQA S 1021
 #else
    static char const * const _defDebugPath = DEFAULT_ACS_PATH "/debug" ; // PRQA S 1021
 #endif
#endif
...
char const * defaultSMPluginsFileName() ACS_NOEXCEPT 
{
    ...
    // hence cannot be declared as a const std::string ;
    static char const * const SMPluginsFileName = DEFAULT_ACS_SMPLUGINS_FILENAME ; // PRQA S 1021
...
char const * defaultStatusPath() ACS_NOEXCEPT 
{
    ...
    static char const * const _defStatusPath = strdup(get_rel_path(DEFAULT_ACS_STATUS_PATH).c_str()) ; // PRQA S 1021, 2706
 #else
    static char const * const _defStatusPath = strdup(get_rel_path("/status").c_str()) ; // PRQA S 2706
 #endif
#else
    ...
    static char const * const _defStatusPath = DEFAULT_ACS_STATUS_PATH ; // PRQA S 1021
 #else
    static char const * const _defStatusPath = DEFAULT_ACS_PATH "/status" ; // PRQA S 1021
 #endif
#endif
...
char const * defaultLogPath() ACS_NOEXCEPT 
{
    ...
    static char const * const _defLogPath = strdup(get_rel_path(DEFAULT_ACS_LOG_PATH).c_str()) ; // PRQA S 1021, 2706
 #else
    static char const * const _defLogPath = strdup(get_rel_path("/log").c_str()) ; // PRQA S 2706
 #endif
#else
    ...
    static char const * const _defLogPath = DEFAULT_ACS_LOG_PATH ; // PRQA S 1021
 #else
    static char const * const _defLogPath = DEFAULT_ACS_PATH "/log" ; // PRQA S 1021
 #endif
#endif
    return _defLogPath ;
}
char const * defaultPersistencePath() ACS_NOEXCEPT 
{
    ...
    static char const * const _defPersistencePath = strdup(get_rel_path(DEFAULT_ACS_PERSISTENCE_PATH).c_str()) ; // PRQA S 1021, 2706
 #else
    static char const * const _defPersistencePath = strdup(get_rel_path("/persistence").c_str()) ; // PRQA S 2706
 #endif
#else
    ...
    static char const * const _defPersistencePath = DEFAULT_ACS_PERSISTENCE_PATH ; // PRQA S 1021
 #else
    static char const * const _defPersistencePath = DEFAULT_ACS_PATH "/persistence" ; // PRQA S 1021
 #endif
#endif
...
char const * defaultMCLogPath() ACS_NOEXCEPT 
{
    ...
    static char const * const _defMCLogPath = strdup(get_rel_path(DEFAULT_MC_ACS_LOG_PATH).c_str()) ; // PRQA S 1021, 2706
 #else
    static char const * const _defMCLogPath = strdup(get_rel_path("/log").c_str()) ; // PRQA S 2706
 #endif
#else
    ...
    static char const * const _defMCLogPath = DEFAULT_MC_ACS_LOG_PATH ; // PRQA S 1021
 #else
    static char const * const _defMCLogPath = DEFAULT_ACS_PATH "/log" ; // PRQA S 1021
 #endif
#endif
...
char const * defaultBinPath() ACS_NOEXCEPT
{
    ...
    static char const * const _defBinPath = strdup(get_rel_path(DEFAULT_ACS_BIN_PATH).c_str()) ; // PRQA S 1021, 2706
 #else
    static char const * const _defBinPath = strdup(get_rel_path("/bin").c_str()) ; // PRQA S 2706
 #endif
#else
    ...
    static char const * const _defBinPath = DEFAULT_ACS_BIN_PATH ; // PRQA S 1021
 #else
    static char const * const _defBinPath = DEFAULT_ACS_PATH "/bin" ; // PRQA S 1021
 #endif
#endif
    return _defBinPath ;
}
...
char const * defaultLockPath() ACS_NOEXCEPT
{
    ...
    // hence cannot be declared as a const std::string ;
    static char const * const _defLockPath = DEFAULT_ACS_LOCK_PATH ; // PRQA S 1021
    return _defLockPath ;
}
...
char const * defaultCorePath() ACS_NOEXCEPT
{
    ...
    // hence cannot be declared as a const std::string ;
    static char const * const _defCorePath = DEFAULT_ACS_CORE_PATH ; // PRQA S 1021
    return _defCorePath ;
}

mode_t defaultLogPermissions() ACS_NOEXCEPT
{
	static mode_t const _defLogPermissions = mode_t(DEFAULT_LOG_PERMISSIONS) ; // PRQA S 1021, 3081, 3082, 3600
	return _defLogPermissions;
} 

mode_t defaultPidPermissions() ACS_NOEXCEPT
{
	static mode_t const _defPidPermissions = mode_t(DEFAULT_ACS_PID_PERMISSIONS) ; // PRQA S 1021, 3081, 3082, 3600
	return _defPidPermissions;
} 
mode_t defaultUuidPermissions() ACS_NOEXCEPT
{
	static mode_t const _defUuidPermissions = mode_t(DEFAULT_ACS_UUID_PERMISSIONS) ; // PRQA S 1021, 3081, 3082, 3600

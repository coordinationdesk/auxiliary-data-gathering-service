...
# define ACS_DECLARE_NO_ASSIGN_CLASS(classname) \
...
#define ACS_DECLARE_NO_COPY_CLASS(classname) \
 ...
 */
// PRQA S 1020,1030 2
#define ACS_DECLARE_NO_COPY_TEMPLATE_CLASS(classname, arg) ACS_DECLARE_NO_COPY_CLASS( classname < arg > )
 ...
 */
// PRQA S 1020,1030 2 
#define ACS_DECLARE_NO_COPY_TEMPLATE_CLASS_2(classname, arg1, arg2) ACS_DECLARE_NO_COPY_CLASS( classname < arg1, arg2 > )
...
#define DEFAULT_ACS_DBCONF_FILENAME "db"
#ifndef PREVENT_ACS_BASE_WARNINGS
...
#define DEFAULT_ACS_SMPLUGINS_FILENAME "smplugins.conf"
#endif

#ifndef DEFAULT_ACS_LOCK_PATH
#define DEFAULT_ACS_LOCK_PATH "/tmp"
#ifndef PREVENT_ACS_BASE_WARNINGS
...
#define DEFAULT_ACS_CORE_PATH "/tmp"
#ifndef PREVENT_ACS_BASE_WARNINGS
#warning *** Default core path as "/tmp" *** (DEFAULT_ACS_CORE_PATH)
#endif
#endif

#ifndef DEFAULT_LOG_PERMISSIONS
#define DEFAULT_LOG_PERMISSIONS 0666 // PRQA S 3600
#ifndef PREVENT_ACS_BASE_WARNINGS
#warning *** Default log files permissions as 0666 *** (DEFAULT_LOG_PERMISSIONS)
#endif
#endif

#ifndef DEFAULT_ACS_PID_PERMISSIONS
#define DEFAULT_ACS_PID_PERMISSIONS 0666 // PRQA S 3600
#ifndef PREVENT_ACS_BASE_WARNINGS
...
#define DEFAULT_ACS_UUID_PERMISSIONS 0666 // PRQA S 3600
#ifndef PREVENT_ACS_BASE_WARNINGS
...
mode_t defaultPidPermissions() ACS_NOEXCEPT ; // 0666 DEFAULT_PID_PERMISSIONS
mode_t defaultUuidPermissions() ACS_NOEXCEPT ; // 0666 DEFAULT_UUID_PERMISSIONS

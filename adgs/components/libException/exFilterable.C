...
exFilterable::~exFilterable() ACS_NOEXCEPT
{
}

bool exFilterable::traversed( exostream const * const s) ACS_NOEXCEPT // PRQA S 4211, 4670
{
    return (traversalRegister_ && traversalRegister_->traversed(s)) ; // PRQA S 3226, 3230
}


bool StreamGraphTraversal::traversed(exostream const * const s) ACS_NOEXCEPT // PRQA S 4020
{
    try {

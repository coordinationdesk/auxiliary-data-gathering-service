...
#warning __GLIBC_HAVE_LONG_LONG not defined: long long integral unsupported
#endif
...
exostream excerr("excerr", exostream::StdCerr) ; // PRQA S 4634 3
exostream excout("excout", exostream::StdCout) ;
exostream excmcf("excmcf", exostream::Cmcf) ;

ACS_CLASS_DEFINE_DEBUG_LEVEL(exostream_Init) 


exostream_Init::exostream_Init() ACS_NOEXCEPT 
{
...
Mutex &exostream::globalMutex() ACS_NOEXCEPT { static Mutex mutex_ ; return mutex_ ; } // PRQA S 2328

exostream *exostream::_defaultErrLogger = 0 ;
exostream *exostream::_defaultOutLogger = 0 ;
exostream *exostream::_defaultCoutLogger = 0 ;
...
exostream::~exostream() ACS_NOEXCEPT
{
// PRQA S 4631 exostream_dtor
    try {
        ...
        for (size_t i=0; i < _filters.size(); ++i) { // PRQA S 4238, 4244
            _filters[i]->streamDestroying(this) ;
        }
...
// PRQA S 4222 EOF
exostream &exostream::operator<<(exFilterable &s) 
{
    Lock const lock(globalMutex()) ;
...
exostream &exostream::operator<<(const std::exception &x) ACS_NOEXCEPT 
{
    Lock const lock(globalMutex()) ;
...
exostream &exostream::operator<<(const std::string &s) // PRQA S 4020 
{
    ...
    for (size_t i=0; i < _connected.size(); ++i) { // PRQA S 4238, 4244
        *(*this)[i] << s ;
    }
    return *this ;
}

exostream &exostream::operator<<(const char *s) // PRQA S 4020 
{
    Lock const lock(globalMutex()) ;
...
exostream &exostream::operator<<(bool v) // PRQA S 4020 
{
    Lock const lock(globalMutex()) ;
...
exostream &exostream::operator<<(char v) // PRQA S 4020 
{
    Lock const lock(globalMutex()) ;
...
exostream &exostream::operator<<(short v) // PRQA S 4020
{        
    Lock const lock(globalMutex()) ;
...
exostream &exostream::operator<<(int v) // PRQA S 4020
{        
    Lock const lock(globalMutex()) ;
...
exostream &exostream::operator<<(long v) // PRQA S 4020
{
    Lock const lock(globalMutex()) ;
...
exostream &exostream::operator<<(float v) // PRQA S 4020
{        
    Lock const lock(globalMutex()) ;
...
exostream &exostream::operator<<(double v) // PRQA S 4020 
{        
    Lock const lock(globalMutex()) ;
...
exostream &exostream::operator<<(long double v) // PRQA S 4020 
{        
    Lock const lock(globalMutex()) ;
...
exostream &exostream::operator<<(unsigned char v) // PRQA S 4020 
{        
    Lock const lock(globalMutex()) ;
...
exostream &exostream::operator<<(unsigned short v) // PRQA S 4020 
{    
    Lock const lock(globalMutex()) ;
...
exostream &exostream::operator<<(unsigned int v) // PRQA S 4020 
{        
    Lock const lock(globalMutex()) ;
...
#if defined __GLIBC_HAVE_LONG_LONG
exostream &exostream::operator<<(signed long long int v) // PRQA S 4020
{        
    Lock const lock(globalMutex()) ;
...
exostream &exostream::operator<<(unsigned long long int v) // PRQA S 4020 
{        
    Lock const lock(globalMutex()) ;
...
exostream &exostream::operator<<(unsigned long v) // PRQA S 4020 
{        
    Lock const lock(globalMutex()) ;
...
exostream &exostream::operator<<(void *v) // PRQA S 4020 
{        
    Lock const lock(globalMutex()) ;
...
exostream &exostream::operator<<(const void *v) // PRQA S 4020 
{        
    Lock const lock(globalMutex()) ;
...
exostream &exostream::operator<<(std::ostream & (*func)(std::ostream &)) // PRQA S 4020 
{
    Lock const lock(globalMutex()) ;
...
#ifdef __linux__
  #if (__GNUC__ < 3)
    exostream & exostream::operator<<(ios & (*func)(ios &))
    {
        Lock const lock(globalMutex()) ;
    ...
    exostream & exostream::operator<<(const smanip<int> &m)
    {
        Lock const lock(globalMutex()) ;
    ...
    exostream & exostream::operator<<(const smanip<__fmtflags> &m)
    {
        Lock const lock(globalMutex()) ;
    ...
    exostream &exostream::operator<<(ios_base & (*func)(ios_base &)) // PRQA S 4020 
    {
        Lock const lock(globalMutex()) ;
    ...
    exostream & exostream::operator<<(std::_Resetiosflags m) // PRQA S 2010, 4020
    {
        Lock const lock(globalMutex()) ;
    ...
    exostream & exostream::operator<<(std::_Setiosflags m) // PRQA S 2010, 4020 
    {
        Lock const lock(globalMutex()) ;
    ...
    exostream & exostream::operator<<(std::_Setbase m) // PRQA S 2010, 4020 
    {
        Lock const lock(globalMutex()) ;
    ...
    exostream & exostream::operator<<(std::_Setfill<char> m) // PRQA S 2010, 4020 
    {
        Lock const lock(globalMutex()) ;
    ...
    exostream & exostream::operator<<(std::_Setprecision m) // PRQA S 2010, 4020 
    {
        Lock const lock(globalMutex()) ;
    ...
    exostream & exostream::operator<<(std::_Setw m) // PRQA S 2010, 4020 
    {
        Lock const lock(globalMutex()) ;
...
#elif defined _AIX
  exostream &exostream::operator<<(ios_base & (*func)(ios_base &)) 
  {
      Lock const lock(globalMutex()) ;
  ...
  exostream & exostream::operator<<(_Smanip<int> m) 
  {
      Lock const lock(globalMutex()) ;
  ...
  exostream & exostream::operator<<(_Fillobj<char> m)
  {
      Lock const lock(globalMutex()) ;
...
exostream &exostream::flush() // PRQA S 4020 
{
    ...
    for (size_t i=0; i < _connected.size(); ++i) { // PRQA S 4238, 4244
        (*this)[i]->flush() ; // each descendant too
    }
    postflush() ; // call postflush ... to recover if needed
    return *this ;
}

exostream *exostream::operator[](size_t idx)
{
    Lock const lock(globalMutex()) ;
    return _connected[idx] ;
}
...
void exostream::set_stream(std::ostream *s) ACS_NOEXCEPT 
{
...
void exostream::preflush() {}
void exostream::postflush() {}


void exostream::removeChild(exostream *s)
{
    Lock const lock(globalMutex()) ;
    vector<exostream *>::iterator const ctdb = find(_connected.begin(),_connected.end(), s) ;
...
void exostream::appendToParents()
{
    ...
    for (size_t i=0; i < _parents.size(); ++i) { // PRQA S 4238, 4244
        if (_parents[i]) {
            _parents[i]->appendChild(this) ;
        }
    }
}
...
exostream &exostream::notify(const std::exception &x) ACS_NOEXCEPT // PRQA S 4020 
{
    Lock const lock(globalMutex()) ;
...
exostream &exostream::notify(exFilterable &s) // PRQA S 4020 
{
    ...
    if ((not s.traversed(this)) && applyFilter(s)) { // filter pass ? // PRQA S 3229, 3230
    ...
    for (size_t i=0; i < _connected.size(); ++i)  { // PRQA S 4238, 4244
        CERR_CLASS_WRITE_DEBUG(ACS_MID_VERB, getName() << " notify to " << (*this)[i]->getName()) ;
        (*this)[i]->notify(s) ;
    }
    return *this ;
}

bool exostream::notifyException(const std::exception &x) ACS_NOEXCEPT // PRQA S 4020 
{
    Lock const lock(globalMutex()) ;
    ...
    if (_mode != Silent) { // am i  verbose or silent ?
        ...
        if (not sm.empty()) {
            try {
                ...
                if (_notifyDetailFromFilterable && not s.detail().empty()) {
                    stream() << '\n' << s.detail() ;
                }
    ...
    case NullStream:
        {
            // -1 -> NullStream
            if (0 == _nullStream) { 
                _nullStream = new ofstream("/dev/null") ; // PRQA S 2707 # dtor deallocate it
            }
            return *_nullStream ; // PRQA S 2844 # _nullStream can't be null
        }
    case Cmcf:    { return cmcf ; } 
    case StdCout: { return cout ; } 
    case StdCerr: { return cerr ; } 
    default: // PRQA S 4612 # falltrough
        {
            ostringstream os ;
            os << "Invalid value: " << _sysFd << " the fd passed at ctor must be in the [0,2] range " ;
...
{
    Lock const lock(globalMutex()) ;
    for (size_t i=0; i < f.size() ; ++i) { // PRQA S 4238, 4244
        if (f[i] && (find(_filters.begin(), _filters.end(), f[i]) == _filters.end())) {
            _filters.push_back(f[i]) ;
        }
    }
}
...
void exostream::uninstallFilter(exFilter *f) 
{
    Lock const lock(globalMutex()) ;
    if (f) { 
        vector<exFilter *>::iterator const ftbd = find(_filters.begin(),_filters.end(), f) ;
...
bool exostream::applyFilter(exFilterable &s) // PRQA S 4020
{
    ...
    if (s.defaultNotify()) { // has defaultnotify ? 
        ...
        for (size_t i=0; i < _filters.size(); ++i) { // PRQA S 4238, 4244
            if (!_filters[i]->filterInsertion(s)) {
                return false ;
            }
        }
...
void exostream::destroying() ACS_NOEXCEPT 
{
    setDestroying() ;
}

void exostream::setDestroying() ACS_NOEXCEPT 
{
    Lock const lock(globalMutex()) ;
    _destroying = true ;
}

bool exostream::isDestroying() const ACS_NOEXCEPT 
{
    Lock const lock(globalMutex()) ;
    return _destroying ;
}
...
std::ostream & operator <<(std::ostream &os , exostream::Mode m) ACS_NOEXCEPT
{
    switch(m) {
...
exostream & operator <<(exostream &os , exostream::Mode m) ACS_NOEXCEPT
{
    switch(m) {
    case exostream::FormattedOnly: 
        {
...
std::ostream & operator <<(std::ostream &os , exostream::StreamFdEquiv f) ACS_NOEXCEPT
{
    switch(f) {
    case exostream::Cmcf:
        {
...
exostream & operator <<(exostream &os , exostream::StreamFdEquiv f) ACS_NOEXCEPT
{
    switch(f) {
    case exostream::Cmcf:
        {
...
exostream &exostream::getDefaultErrLogger() { // PRQA S 4020
    Lock const lock(globalMutex()) ;
    if (not _defaultErrLogger) { return excerr ; }
    return *_defaultErrLogger ;
}

exostream *exostream::setDefaultErrLogger(exostream *s) ACS_NOEXCEPT 
{
    Lock const lock(globalMutex()) ;
...
exostream &exostream::getDefaultOutLogger() ACS_NOEXCEPT {  // PRQA S 4020
    Lock const lock(globalMutex()) ;
    if (not _defaultOutLogger) { return excerr ; }
    return *_defaultOutLogger ;
}

exostream *exostream::setDefaultOutLogger(exostream *s) ACS_NOEXCEPT 
{
    Lock const lock(globalMutex()) ;
...
exostream &exostream::getDefaultCoutLogger() ACS_NOEXCEPT {  // PRQA S 4020
    Lock const lock(globalMutex()) ;
    if (not _defaultCoutLogger) { return excout ; }
    return *_defaultCoutLogger ;
}

exostream *exostream::setDefaultCoutLogger(exostream *s) ACS_NOEXCEPT 
{
    Lock const lock(globalMutex()) ;
...
exLogStream::~exLogStream() ACS_NOEXCEPT
{
    try {
        ...
        delete _logfile; // PRQA S 4631
        _logfile = 0;
    }
    catch(exception &e) { // PRQA S 4631 3
        cerr << explain(e) ;
    }
}
...
time_t exLogStream::creationTime() // PRQA S 4211
{
...
void exLogStream::setPermission(mode_t mode) // PRQA S 4211
{
...
void exLogStream::open()
{
    ...
    try {
        try {
            ...
            _logfile= new ofstream(_fname.c_str(), 
                                    append ? // PRQA S 3380, 3385
                                        std::ios::out | std::ios::app | std::ios::ate : 
                                        std::ios::out | std::ios::trunc
                                  ) ;
            if (!_logfile) { // PRQA S 2992, 2996 # by design exist an operator to do that
...
void exLogStream::close() ACS_NOEXCEPT
{
    Lock const lock(globalMutex()) ;
    set_stream(0) ;
    try {
...
exBaseStream::~exBaseStream() ACS_NOEXCEPT
{
...
exSyslog::~exSyslog() ACS_NOEXCEPT
{
...
int exSyslog::get_prio(const exFilterable &s) ACS_NOEXCEPT // PRQA S 4020
{
    // PRQA S 3081 L3
...
exLogStringStream::~exLogStringStream() ACS_NOEXCEPT
{
    set_stream(0) ;
}
...
exHandler::~exHandler() ACS_NOEXCEPT
{
...
bool exHandler::notifyException(const std::exception &x) ACS_NOEXCEPT
{
    const exException *ex = dynamic_cast<const exException *>(&x) ; // PRQA S 3081

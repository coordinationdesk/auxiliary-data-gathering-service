...
class DiskEventNotifier : public Thread { // PRQA S 2109
		
public:

    struct EventElement // PRQA S 2173, 2175
    {
        // PRQA S 2100 5
	    ...
	    ~EventElement() throw() {};
	    // Copy Ctor
	    EventElement(EventElement const &);
	    // assign operator
	    EventElement & operator = (EventElement const &);
    ...
    public:
        ...
        exDECLARE_EXCEPTION(NoDataFound, exException) ; // PRQA S 2131, 2502

        // Ctor
        EventElementsList();
        ~EventElementsList();
        // Copy Ctor
        EventElementsList(EventElementsList const &);
        // assign operator
        EventElementsList & operator = (EventElementsList const &);
    ...
    exDECLARE_EXCEPTION(DiskEventNotifierException, exException) ;  // PRQA S 2131, 2502
    ...
    */
    virtual ~DiskEventNotifier() throw();
...
private:
    ...
    DiskEventNotifier() ; // unimplemented
	/**
	 * \brief  Class copy constructor 
	 *    
	 */
	DiskEventNotifier(const DiskEventNotifier &) ;
	
	/**
	 * \brief  Class operator = 
	 *    
	 */
	DiskEventNotifier &operator=(const DiskEventNotifier &) ;

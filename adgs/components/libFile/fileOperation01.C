...
// copy constructor
fileOperation01::fileOperation01(const fileOperation01 &rhs) :
	Operation01(rhs) 
{
    // empty
}	
...
fileOperation01::~fileOperation01() throw()
{
    // empty
}
...
// operator =
fileOperation01 &fileOperation01::operator=(const fileOperation01 &rhs)
{
	if(this != &rhs)
	{

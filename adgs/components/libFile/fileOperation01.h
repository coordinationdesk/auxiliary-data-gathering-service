...
public:
	...
	virtual ~fileOperation01() throw() ;

	fileOperation01(const fileOperation01 &) ;
	fileOperation01 &operator=(const fileOperation01 &) ; // operator =

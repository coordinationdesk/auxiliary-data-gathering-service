...
public:
    FtpListItem();
    ~FtpListItem() throw() ;
    FtpListItem(FtpListItem const& ) ;
    FtpListItem& operator=(FtpListItem const& );

    std::string str() const;

    const DateTime &getDateTime() const throw() ;

    const std::string &getGroup() const throw() ;

    const std::string & getName() const throw() ;

    long getNumberOfFiles() const throw() ;

    const std::string &getOwner() const throw() ;

    const FilePermissions &getPermissions() const throw() ;
...
private:
    ...
    void setNumberOfFiles(long) throw() ;

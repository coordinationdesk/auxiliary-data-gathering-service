...
public:
    ...
    void setOutStream(acs::io::OutputStream* ) throw() ;
    void setInStream(acs::io::InputStream* ) throw() ;
...
private:
    ...
    StreamCurl(); // not implemented
    StreamCurl(StreamCurl const& ); // not implemented
    StreamCurl& operator=(StreamCurl const& ); // not implemented
private:
    GetCallback _streamGetCallback;
    PutCallback _streamPutCallback;
    long long  _bytesWrote ;
    long long  _bytesRead;
    acs::io::InputStream* _inStream;
    acs::io::OutputStream* _outStream;
    FtpPerformance _perfo;
    const StopController & _stopController;
    CURLcode& _res;
    const BandPriority &band_prio_ ;
	bool _removeTargetBeforeTransfer ;
...
public:
    ...
    virtual ~StreamCurlThread() throw ();
...
private:
    StreamCurlThread(); // not implemented
    StreamCurlThread(StreamCurlThread const& ); // not implemented
    StreamCurlThread& operator=(StreamCurlThread const& ); // not implemented

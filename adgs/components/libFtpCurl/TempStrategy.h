...
public:
     ...
     * \brief Destructor
     */
    virtual ~AbstractTempStrategy() throw();
...
protected:
	 ...
	 */
    AbstractTempStrategy(const AbstractTempStrategy & ) ;
    
	/**
	 * \brief Assignment operator overload.
	 */
    AbstractTempStrategy & operator=(const AbstractTempStrategy & ) ;
};
...
public:
	 ...
	 * \brief Destructor
	 */
    virtual ~TempDirStrategy() throw() ;

	/**
	 * \brief Returns true if this class applies the naming strategy to parent directories, false otherwise
	 */
    virtual bool isDirNameChanged() const ;
    
	/**
	 * \brief Returns true if this class applies the naming strategy to file names, false otherwise
	 */
    virtual bool isFileNameChanged() const;
    
 	/**
	 * \brief Applies the naming strategy (if any) to the parent directory of the input path
	 * 		  The computation of the temporary directory name is obviously deterministic for a given path.
	 */   
    virtual std::string getTemporaryDir(std::string const& path) const ;
    
	/**
	 * \brief Applies the naming strategy (if any) to the filename of the input path
	 * 		  The computation of the temporary filename is obviously deterministic for a given path.
	 */
    virtual std::string getTemporaryFile(std::string const& path) const ;
    
 	/**
	 * \brief Clones the object
	 */   
	virtual AbstractTempStrategy* clone() const;
	
private:
	
	// implicit default CTOR does not exists because another ctor exists

	/**
	 * \brief Copy constructor. Defined but not implemented
	 */	
    TempDirStrategy(const TempDirStrategy & ) ;
    
	/**
	 * \brief Assignment operator overload. Defined but not implemented
	 */
    TempDirStrategy & operator=(const TempDirStrategy & ) ;
...
public:
	 ...
	 * \brief Destructor
	 */
    virtual ~PrefixTempStrategy() throw() ;
...
private:
	 ...
	 * \brief Copy constructor. Defined but not implemented
	 */		
    PrefixTempStrategy(const PrefixTempStrategy &) ;
    
 	/**
	 * \brief Assignment operator overload. Defined but not implemented
	 */   
    PrefixTempStrategy &operator=(const PrefixTempStrategy &) ;
...
public:
	 ...
	 * \brief Destructor
	 */
    virtual ~PostfixTempStrategy() throw() ;
...
private:
	 ...
	 * \brief Copy constructor. Defined but not implemented
	 */		
    PostfixTempStrategy(const PostfixTempStrategy & ) ;
    
 	/**
	 * \brief Assignment operator overload. Defined but not implemented
	 */     
    PostfixTempStrategy & operator=(const PostfixTempStrategy & ) ;// not implemented
...
public:
	 ...
	 * \brief Destructor
	 */
    virtual ~TimestampTempStrategy() throw();
...
private:
	 ...
	 * \brief Copy constructor. Defined but not implemented
	 */
    TimestampTempStrategy(const TimestampTempStrategy & ) ;
    
 	/**
	 * \brief Assignment operator overload. Defined but not implemented
	 */  
    TimestampTempStrategy & operator=(const TimestampTempStrategy & ) ;
    
private:
    std::string prefix_ ;
    Mutex mutex_;
    mutable bool isValidCache_;
...
private:
	 ...
	 * \brief Copy constructor. Defined but not implemented
	 */
    NoTempStrategy(const NoTempStrategy &);// not implemented

 	/**
	 * \brief Assignment operator overload. Defined but not implemented
	 */
    NoTempStrategy& operator=(const NoTempStrategy &);// not implemented
};

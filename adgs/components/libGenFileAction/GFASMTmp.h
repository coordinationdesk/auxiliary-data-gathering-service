...
struct GFASMTmp // PRQA S 2173, 2175
{

	GFASMTmp(dbPersistent::IdType smid, const std::string &smtype, dbPersistent::IdType recid) ;
	GFASMTmp() ;
	~GFASMTmp() throw() ;
	GFASMTmp(const GFASMTmp &) ;
	GFASMTmp &operator=(const GFASMTmp &) ;

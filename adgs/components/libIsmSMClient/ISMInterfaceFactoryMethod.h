...
public:
	...
	virtual ~ISMInterfaceFactoryMethod() throw() ;
...
private:
	...
	ISMInterfaceFactoryMethod() ;
	ISMInterfaceFactoryMethod(const ISMInterfaceFactoryMethod &) ;
	ISMInterfaceFactoryMethod &operator=(const ISMInterfaceFactoryMethod &) ;

private:
	static ISMInterfaceFactoryMethod _theMethod ;

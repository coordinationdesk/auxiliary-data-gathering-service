...
private:
	...
	void retryConnectionToServer( std::string  const & errMsg, Timer & timer, int attempt, unsigned short &endpointToTry );
...
private:	
	...
	static const int _defaultSoapRecvTimeout = -30000000; // negative value to set us -> 30 s

...
class MQTTPublisher : public MQTTWorker
{

public:
	MQTTPublisher(const std::string& name, const struct MQTTWorker::Configuration& config,  StopController const& stopController = AppStopController()) ;
	virtual ~MQTTPublisher() ACS_NOEXCEPT;

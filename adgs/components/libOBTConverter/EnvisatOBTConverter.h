...
#ifndef _EnvisatOBTConverter_H_
#define _EnvisatOBTConverter_H_ 
...
/**
 * This class handles operations on COSMO On Board Time
 */

class EnvisatOBTConverter : public OBTConverter
{
public:
	 ...
	 */	
	EnvisatOBTConverter(OBTFileParser*);

	/**
	 * \brief  Class destructor 
	 */
	virtual ~EnvisatOBTConverter() throw();

	/**
	 * \brief  Class copy constructor 
	 */ 
	EnvisatOBTConverter(const EnvisatOBTConverter & ); 

	/**
	 * \brief  Operator= 
	 */
	EnvisatOBTConverter &operator=(const EnvisatOBTConverter &);
...
private:
	...
	static const long long int BIG_NEGATIVE_THREASHOLD;

	std::string    _fileName;
	OBTFileParser* _parser;

	ACS_CLASS_DECLARE_DEBUG_LEVEL(EnvisatOBTConverter) ;

};//end EnvisatOBTConverter class
_ACS_END_NAMESPACE
#endif //_EnvisatOBTConverter_H_

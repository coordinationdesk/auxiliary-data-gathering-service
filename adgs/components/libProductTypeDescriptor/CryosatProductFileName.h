...
/*
	...
	Revision 2.1  2007/07/05 09:10:44  giucas
	...
	Revision 1.5  2004/02/03 14:05:59  marfav
	Added support for Level2 products
	
	Revision 1.4  2004/01/09 10:27:55  marfav
	Added skipNameSizeCheck parameter to checkNameValidity method
	
	Revision 1.3  2003/10/23 08:04:24  giucas
	Added isValidName and isValidRoot methods for L0 and L1 products
	
	Revision 1.2  2003/10/13 15:36:34  giucas
	Added method getFileClassFromRoot
	
	Revision 1.1  2003/09/09 13:11:25  giucas
...
#ifndef _CryosatProductFileName_H_
#define _CryosatProductFileName_H_ 
...
class CryosatProductFileName : public ProductFileName
{
public:
	 ...
	 */	
	CryosatProductFileName();

	/**
	 * \brief  Class destructor 
	 */
	virtual ~CryosatProductFileName() throw();
...
private:
	 ...
	 */
	CryosatProductFileName(const CryosatProductFileName & ); 


	/**
	 * \brief  Operator=
	 */
	CryosatProductFileName &operator=(const CryosatProductFileName &);
...
/////////////////////////////////////////////
	...
	ACS_CLASS_DECLARE_DEBUG_LEVEL(CryosatProductFileName) ;
};

_ACS_END_NAMESPACE


#endif //_CryosatProductFileName_H_

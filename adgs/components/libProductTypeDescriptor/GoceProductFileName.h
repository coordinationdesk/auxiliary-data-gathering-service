...
/*
	...
	Revision 1.3  2004/12/03 09:50:40  giucas
	Header fixed
...
#ifndef _GoceProductFileName_H_
#define _GoceProductFileName_H_ 
...
class GoceProductFileName : public ProductFileName
{
public:
	 ...
	 */
	virtual ~GoceProductFileName() throw();
...
private:
	 ...
	 */
	GoceProductFileName(const GoceProductFileName & ); 


	/**
	 * \brief  Operator=
	 */
	GoceProductFileName &operator=(const GoceProductFileName &);
...
/////////////////////////////////////////////
	...
	ACS_CLASS_DECLARE_DEBUG_LEVEL(GoceProductFileName) ;
};

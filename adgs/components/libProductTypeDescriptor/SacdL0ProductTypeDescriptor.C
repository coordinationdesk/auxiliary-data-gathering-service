...
SacdL0ProductTypeDescriptor::SacdL0ProductTypeDescriptor() :
	L0ProductTypeDescriptor("Sacd")
{
}


//class constructor
SacdL0ProductTypeDescriptor::SacdL0ProductTypeDescriptor(const string& satName) :
...
//Class destructor
SacdL0ProductTypeDescriptor::~SacdL0ProductTypeDescriptor() throw()
{
}

...
#ifndef _DefaultAbortCmd_H_
#define _DefaultAbortCmd_H_

#include <ScAbstractCommand.h>

_ACS_BEGIN_NAMESPACE(acs)

class DefaultAbortCmd : public ScAbstractCommand // PRQA S 2153
{

public:
	DefaultAbortCmd();
	DefaultAbortCmd(const DefaultAbortCmd&);
	DefaultAbortCmd& operator= (const DefaultAbortCmd&);
    virtual ~DefaultAbortCmd() throw() {} // PRQA S 2131

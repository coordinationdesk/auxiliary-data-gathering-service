...
DefaultKillCmd::DefaultKillCmd() : ScAbstractCommand()
{}


DefaultKillCmd::DefaultKillCmd(const DefaultKillCmd& r) : ScAbstractCommand(r)
{
}


DefaultKillCmd& DefaultKillCmd::operator= (const DefaultKillCmd& r)
{
	if (this != &r)
	{
...
void DefaultKillCmd::execute (ExecutorBase& e)
{
	e.armageddon (SIGKILL);
}

string DefaultKillCmd::getSignature () const
{
	return "DefaultKillCmd";
}

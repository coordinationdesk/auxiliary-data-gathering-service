...
#ifndef _DefaultKillCmd_H_
#define _DefaultKillCmd_H_

#include <ScAbstractCommand.h>

_ACS_BEGIN_NAMESPACE(acs)

class DefaultKillCmd : public ScAbstractCommand  // PRQA S 2153
{

public:
	DefaultKillCmd();
	DefaultKillCmd(const DefaultKillCmd&);
	DefaultKillCmd& operator= (const DefaultKillCmd&);
    virtual ~DefaultKillCmd() throw() {} // PRQA S 2131

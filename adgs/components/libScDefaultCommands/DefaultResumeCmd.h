...
#ifndef _DefaultResumeCmd_H_
#define _DefaultResumeCmd_H_
...
class DefaultResumeCmd : public ScAbstractCommand // PRQA S 2153
{

public:
	DefaultResumeCmd();
	DefaultResumeCmd(const DefaultResumeCmd&);
	DefaultResumeCmd& operator= (const DefaultResumeCmd&);
    virtual ~DefaultResumeCmd() throw() {} // PRQA S 2131

...
#ifndef _DefaultUserCmd_H_
#define _DefaultUserCmd_H_

#include <ScAbstractCommand.h>

_ACS_BEGIN_NAMESPACE(acs)

class DefaultUserCmd : public ScAbstractCommand // PRQA S 2153
{
public:
	DefaultUserCmd();
	DefaultUserCmd(const DefaultUserCmd&);
	DefaultUserCmd& operator= (const DefaultUserCmd&);
    virtual ~DefaultUserCmd() throw() {} // PRQA S 2131

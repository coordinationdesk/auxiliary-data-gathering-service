...
//
//
ScErrFilterable::ScErrFilterable() :
	ScFilterable("ScErrFilterable")
{
}

ScErrFilterable::ScErrFilterable(const string& originator) :
	ScFilterable("ScErrFilterable", originator)
{
}


ScErrFilterable::~ScErrFilterable() throw()
{
}

void ScErrFilterable::notify(const string &msg, const string& originator, exostream &o)
{
	ScErrFilterable f(originator) ;
	f << msg ;
	o << f ;
}
...
bool ScErrFilterable::defaultNotify() const
{
	return true ;
}

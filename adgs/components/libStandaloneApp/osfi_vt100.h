 ...
 * Copyright 2008 Deimos Space, S.L.
 *
 * This file is part of OSFI. OSFI is free software; you can redistribute it
 * and/or modify it under the terms of the 'ESA Software Community License - Type 3' as
 * published by the European Space Agency; either version 1.1 of the License,
 * or (at your option) any later version. OSFI is distributed in the hope that
 * it will be useful, but WITHOUT ANY WARRANTY; without even the implied
 * warranty of MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE. See the
 * 'ESA Software Community License - Type 3' for more details. You should have received a
 * copy of the 'ESA Software Community License - Type 3' along with this program
 * or can be found at <http://eop-cfi.esa.int/index.php/docs-and-mission-data/licensing-documents>.
 *
 * SVN
 * $LastChangedDate: 2010-05-20 12:49:24 +0100 (Thu, 20 May 2010) $

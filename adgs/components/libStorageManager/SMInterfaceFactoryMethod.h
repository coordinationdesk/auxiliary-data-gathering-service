...
{
public:
	virtual ~SMInterfaceFactoryMethod() throw() ;
...
private:
	...
	SMInterfaceFactoryMethod() ;
	SMInterfaceFactoryMethod(const SMInterfaceFactoryMethod &) ;
	SMInterfaceFactoryMethod &operator=(const SMInterfaceFactoryMethod &) ;

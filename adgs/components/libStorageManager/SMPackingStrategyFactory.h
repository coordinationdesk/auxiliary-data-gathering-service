 ...
 * 	Copyright 1995-2013, Advanced Computer Systems , Inc.
	...
	$Prod: A.C.S. StorageManger Library $
...
public:
	...
	virtual ~SMPackingStrategyFactory() throw() ;
...
private:
	...
	SMPackingStrategyFactory(const SMPackingStrategyFactory &) ;
	SMPackingStrategyFactory &operator=(const SMPackingStrategyFactory &) ;	

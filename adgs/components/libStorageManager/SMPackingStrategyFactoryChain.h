...
public:
	virtual ~SMPackingStrategyFactoryChain() throw() ;

	// registers a new factory
	void registerFactory(SMPackingStrategyFactory *) ;
	// unregisters a new factory
	void unregisterFactory(SMPackingStrategyFactory *) throw() ;
	
//	virtual bool ableToManage(const dbPersistent *) const;
...
private:
	...
	SMPackingStrategyFactoryChain(const SMPackingStrategyFactoryChain &) ;
	SMPackingStrategyFactoryChain &operator=(const SMPackingStrategyFactoryChain &) ;

...
public:
	virtual ~StorageName() throw() ; 
	
protected:
	StorageName(const std::string &tbl, const std::string &pk, const std::string &col,const std::string &key) ; 
	
private:
	StorageName &operator=(const StorageName &) ; 	// declared but not implemented
	StorageName (const StorageName &) ; 			// declared but not implemented
	StorageName () ; 			// declared but not implemented

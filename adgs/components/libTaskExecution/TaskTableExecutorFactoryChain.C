...
TaskTableElementExecutor* buildTaskTableElementExecutor(const TaskTableElementExecutor::BuildParameters& params)
{
	return new TaskTableElementExecutor(params);
}

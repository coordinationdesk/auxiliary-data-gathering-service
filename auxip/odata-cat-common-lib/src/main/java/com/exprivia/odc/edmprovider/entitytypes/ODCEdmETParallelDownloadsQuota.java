...
public class ODCEdmETParallelDownloadsQuota implements ODCEdmEntityType {
	public static final String ET_NAME = "ParallelDownloadsQuota";
	...
	public CsdlEntityType getCsdlEntityType() {
		...
		entityType.setBaseType(ODCEdmETDownloadQuota.ET_FQN);

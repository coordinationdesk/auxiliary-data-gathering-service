...
public class ODCEdmETParallelOrdersQuota implements ODCEdmEntityType {
	public static final String ET_NAME = "ParallelOrdersQuota";
	...
	public CsdlEntityType getCsdlEntityType() {
		...
		entityType.setBaseType(ODCEdmETOrderQuota.ET_FQN);

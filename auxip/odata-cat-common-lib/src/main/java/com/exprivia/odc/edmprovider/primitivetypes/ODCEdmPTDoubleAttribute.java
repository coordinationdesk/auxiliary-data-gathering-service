...
public class ODCEdmPTDoubleAttribute extends ODCEdmPrimitive implements ODCEdmEntityType {
	...
	public CsdlEntityType getCsdlEntityType() {
		return createAttribute(ET_NAME, ET_VALUE_NAME, EdmPrimitiveTypeKind.Double);
	}

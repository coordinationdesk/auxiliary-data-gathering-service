...
VariableDateTime::VariableDateTime() noexcept :
    _year(),
    _month(),
    _day(),
    _dayOfTheWeek(),
...
VariableDateTime::VariableDateTime(string const & time) :
    _year(),
    _month(),
    _day(),
    _dayOfTheWeek(),
...
void VariableDateTime::load(string const & time)
{
...
void VariableDateTime::salloCheck(string const & time) const
{
...
bool VariableDateTime::last(DateTime & dueTime) const // PRQA S 4020
{
...
void VariableDateTime::clear() noexcept 
{
...
void VariableDateTime::print() const
{
...
unsigned long VariableDateTime::readNumber(string const & s)
{
...
void VariableDateTime::parseValues( // PRQA S 4020
...
bool VariableDateTime::matchValue(unsigned long value, vector<unsigned long> const & data) const // PRQA S 4020
{

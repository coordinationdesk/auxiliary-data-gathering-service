/*
	...
	$Log$
	Revision 1.3  2007/02/27 18:11:31  marqua
	Creating new tag.
	
	Revision 1.2  2007/02/27 18:11:27  marqua
...
const char * pydtV::_name = "@(#) $Prod: A.C.S. pyDateTime $$Revision$$Date$" ;
const char* pydtV::_tag = "$Name$" ;

...
public:
	BandName &operator=(BandName &&) = delete ;
	BandName (BandName &&) = delete ;
	BandName &operator=(const BandName &) = delete ;
	BandName (const BandName &) = delete ;
	BandName () = delete ;
	virtual ~BandName() = default ;

...
public:
	DataModeName &operator=(DataModeName &&) = delete ;
	DataModeName (DataModeName &&) = delete ;
	DataModeName &operator=(const DataModeName &) = delete ;
	DataModeName (const DataModeName &) = delete ;
	DataModeName () = delete ;
	virtual ~DataModeName() = default ;

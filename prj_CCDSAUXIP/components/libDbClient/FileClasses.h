...
public:
	FileClasses &operator=(FileClasses &&) = delete ;
	FileClasses (FileClasses &&) = delete ;
	FileClasses &operator=(const FileClasses &) = delete ;
	FileClasses (const FileClasses &) = delete ;
	FileClasses () = delete ;
	virtual ~FileClasses() = default ;

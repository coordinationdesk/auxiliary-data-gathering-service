...
public:
	QualifiedFlag &operator=(QualifiedFlag &&) = delete ;
	QualifiedFlag (QualifiedFlag &&) = delete ;
	QualifiedFlag &operator=(const QualifiedFlag &) = delete ;
	QualifiedFlag (const QualifiedFlag &) = delete ;
	QualifiedFlag () = delete ;
	virtual ~QualifiedFlag() = default ;

...
public:
	RollingPoliciesActions &operator=(RollingPoliciesActions &&) = delete ;
	RollingPoliciesActions (RollingPoliciesActions &&) = delete ;
	RollingPoliciesActions &operator=(const RollingPoliciesActions &) = delete ;
	RollingPoliciesActions (const RollingPoliciesActions &) = delete ;
	RollingPoliciesActions () = delete ;
	virtual ~RollingPoliciesActions() = default ;

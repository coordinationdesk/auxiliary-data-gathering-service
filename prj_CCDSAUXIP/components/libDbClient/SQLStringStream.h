	...
	class orderby_string
	{
		...
		*/
		public:
			...
			virtual ~orderby_string() noexcept {}
			std::string get_s() const { return _s ; } 
		private:
			std::string _s ;
	};
	...
	class groupby_string
	{
		...
		*/
		...
		public:
			...
			virtual ~groupby_string() noexcept {}
			std::string get_s() const { return _s ; } 
		private:
			std::string _s ;
	};
...
public:
	...
	class SubExpression 
	{
		public:
			...
			virtual ~SubExpression() noexcept ;
	...
	virtual ~SQLStringStream() noexcept ;

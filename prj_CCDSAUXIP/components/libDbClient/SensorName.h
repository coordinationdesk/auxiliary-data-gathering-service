...
public:
	SensorName () = delete ;
	SensorName (const SensorName &) = delete ;
	SensorName &operator=(const SensorName &) = delete ;
	SensorName (SensorName &&) = delete ;
	SensorName &operator=(SensorName &&) = delete ;
	virtual ~SensorName() = default ;

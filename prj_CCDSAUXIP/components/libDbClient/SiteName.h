...
public:
	SiteName &operator=(SiteName &&) = delete ;
	SiteName (SiteName &&) = delete ;
	SiteName &operator=(const SiteName &) = delete ;
	SiteName (const SiteName &) = delete ;
	SiteName () = delete ;
	virtual ~SiteName() = default ;
...
public:
	SiteTypeName &operator=(SiteTypeName &&) = delete ;
	SiteTypeName (SiteTypeName &&) = delete ;
	SiteTypeName &operator=(const SiteTypeName &) = delete ;
	SiteTypeName (const SiteTypeName &) = delete ;
	SiteTypeName () = delete ;
	virtual ~SiteTypeName() = default ; // PRQA S 2131

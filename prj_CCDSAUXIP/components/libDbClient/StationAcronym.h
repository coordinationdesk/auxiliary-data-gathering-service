...
public:
	StationAcronym &operator=(StationAcronym &&) = delete ;
	StationAcronym (StationAcronym &&) = delete ;
	StationAcronym &operator=(const StationAcronym &) = delete ;
	StationAcronym (const StationAcronym &) = delete ;
	StationAcronym () = delete ;
	virtual ~StationAcronym() = default ;

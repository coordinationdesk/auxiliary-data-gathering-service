...
public:
	StationName &operator=(StationName &&) = delete ;
	StationName (StationName &&) = delete ;
	StationName &operator=(const StationName &) = delete ;
	StationName (const StationName &) = delete ;
	StationName () = delete ;
	virtual ~StationName() = default ;

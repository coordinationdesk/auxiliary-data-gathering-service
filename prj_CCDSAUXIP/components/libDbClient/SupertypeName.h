...
public:
	SupertypeName &operator=(SupertypeName &&) = delete ;
	SupertypeName (SupertypeName &&) = delete ;
	SupertypeName &operator=(const SupertypeName &) = delete ;
	SupertypeName (const SupertypeName &) = delete ;
	SupertypeName () = delete ;
	virtual ~SupertypeName() = default ;

...
public:
	...
	dbAppResSet(const dbAppResSet &) = delete ;
	dbAppResSet &operator=(const dbAppResSet &) = delete ; 
...
private:
	...
	static std::map<std::string, dbAppResSet* , std::less<> > _instances ; 

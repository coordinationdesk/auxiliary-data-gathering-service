...
dbConv::dbConv(const string &key, const bool &v) :
	_str(v ? // PRQA S 3380
...
dbConv::dbConv(const string &key, const NullValue &v) :
	_str(SQLDialectFactory::sqlDialect(key).nullValue())
{
}
	
dbConv::dbConv(const string &key, const char *v) : _str(v)
{
	quotecheck(key) ;
}

dbConv::dbConv(const string &key, char v) :
...
dbConv::dbConv(const string &key, const string &v) : _str(v)
{
	quotecheck(key) ;
}


dbConv::dbConv(const string &key, const DateTime &v, DateTimeMode mode) :
    _str()
{
    using std::setw ;
    using std::setfill ;
...
{
	ostringstream os  ;
	os << std::setprecision(8) << v ; // PRQA S 4400
	_str = os.str() ;
}
...
{
	ostringstream os  ;
	os << std::setprecision(16) << v ; // PRQA S 4400
	_str = os.str() ;
}
...
{
	ostringstream os  ;
	os << std::setprecision(24) << v ; // PRQA S 4400
	_str = os.str() ;
}
...
dbConv::operator const string &() const { return _str ; } 

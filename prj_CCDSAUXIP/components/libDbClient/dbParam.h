...
public:
	...
	public:
		virtual ~dbParamItem() = default ; // PRQA S 2131
		
		virtual dbParamItem *clone() const = 0 ; // PRQA S 2502
		virtual std::string getValue() const = 0 ;

	protected:
        dbParamItem() = delete ; // not implemented
		explicit dbParamItem(const std::string &key) : _key(key) { }
		dbParamItem(const dbParamItem &) = default ;
		dbParamItem &operator=(const dbParamItem &) = default ;
		dbParamItem(dbParamItem &&) = default ;
		dbParamItem &operator=(dbParamItem &&) = default ;
	protected:
	...
	public:
        dbStringParamItem() = delete ;
		dbStringParamItem(const std::string &k, const std::string &s) : dbParamItem(k), _s(s) {}
        dbStringParamItem(const dbStringParamItem &) = default ;
        dbStringParamItem & operator=(const dbStringParamItem &) = default ;
        dbStringParamItem(dbStringParamItem &&) = default ;
        dbStringParamItem & operator=(dbStringParamItem &&) = default ;
		virtual ~dbStringParamItem() = default ; // PRQA S 2131
	...
	public:
        dbIntParamItem() = delete ;
		dbIntParamItem(const std::string &k, int v) : dbParamItem(k), _v(v) {}
        dbIntParamItem(const dbIntParamItem &) = default ;
        dbIntParamItem & operator=(const dbIntParamItem &) = default ;
        dbIntParamItem(dbIntParamItem &&) = default ;
        dbIntParamItem & operator=(dbIntParamItem &&) = default ;
		virtual ~dbIntParamItem() = default ;
	...
	public:
        dbULLParamItem() = delete ;
		dbULLParamItem(const std::string &k, unsigned long long v) : dbParamItem(k), _v(v) {}
        dbULLParamItem(const dbULLParamItem &) = default ;
        dbULLParamItem & operator=(const dbULLParamItem &) = default ;
        dbULLParamItem(dbULLParamItem &&) = default ;
        dbULLParamItem & operator=(dbULLParamItem &&) = default ;
		virtual ~dbULLParamItem() = default ;
	...
	public:
        dbLLParamItem() = delete ;
		dbLLParamItem(const std::string &k, long long v) : dbParamItem(k), _v(v) {}
        dbLLParamItem(const dbLLParamItem &) = default ;
        dbLLParamItem & operator=(const dbLLParamItem &) = default ;
        dbLLParamItem(dbLLParamItem &&) = default ;
        dbLLParamItem & operator=(dbLLParamItem &&) = default ;
		virtual ~dbLLParamItem() = default ;
	...
	// do not define any move ctor and move assignment	
	
	virtual ~dbParam() noexcept ; 

...
public :
    ...
    dbTemporaryTable() = delete ;
    dbTemporaryTable(const dbTemporaryTable &) = delete ;
    dbTemporaryTable& operator= (const dbTemporaryTable &) = delete ;

	~dbTemporaryTable() noexcept ;
...
public:	
    ...
    */
    ...
    static size_t execForSet(dbSet &,

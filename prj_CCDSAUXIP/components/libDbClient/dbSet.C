...
size_t dbSet::size() const noexcept { return _set.size() ; } // PRQA S 4120
bool dbSet::empty() const noexcept { return _set.empty() ; }
const vector<dbRow> &dbSet::set() const noexcept { return _set ; }   // PRQA S 4120

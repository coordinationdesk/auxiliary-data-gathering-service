...
public:
	...
	dbDownloadFile() = delete ;
	dbDownloadFile(const dbDownloadFile &) = delete ;
	dbDownloadFile &operator=(const dbDownloadFile &) = delete ;
	dbDownloadFile( dbDownloadFile &&) = delete ;
	dbDownloadFile &operator=( dbDownloadFile &&) = delete ;
	virtual ~dbDownloadFile() noexcept ;
	 ...
	 */
    bool smActionsDisabled() const noexcept {return _smActionsDisabled;};
    void smActionsDisabled(bool b) noexcept {_smActionsDisabled = b;};

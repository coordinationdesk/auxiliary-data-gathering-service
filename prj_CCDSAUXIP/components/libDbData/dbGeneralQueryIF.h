...
struct dbGeneralQueryIF // PRQA S 2171, 2173, 2175
{
    ...
    virtual ~dbGeneralQueryIF() noexcept {} // PRQA S 2131
    
protected:
    dbGeneralQueryIF() noexcept {} 
    dbGeneralQueryIF(const dbGeneralQueryIF &) noexcept {} 
    dbGeneralQueryIF & operator= (const dbGeneralQueryIF &) noexcept { return * this ; } // PRQA S 4072
} ; 

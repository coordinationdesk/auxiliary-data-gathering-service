...
public:
	...
	dbPersistentFactoryChain(const dbPersistentFactoryChain &) = delete ;
	dbPersistentFactoryChain &operator=(const dbPersistentFactoryChain &) = delete ;
	dbPersistentFactoryChain(dbPersistentFactoryChain &&) = delete ;
	dbPersistentFactoryChain &operator=(dbPersistentFactoryChain &&) = delete ;
	virtual ~dbPersistentFactoryChain() noexcept ;

...
public:
    ...
    virtual ~dbPersistentOperatorIF() = default ;

protected:
	dbPersistentOperatorIF() = default ;
	dbPersistentOperatorIF &operator=(const dbPersistentOperatorIF &) = default ;
	dbPersistentOperatorIF(const dbPersistentOperatorIF &) = default ;
	dbPersistentOperatorIF &operator=(dbPersistentOperatorIF &&) = default ;
	dbPersistentOperatorIF(dbPersistentOperatorIF &&) = default ;

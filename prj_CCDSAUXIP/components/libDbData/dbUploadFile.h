...
public:	
	 ...
	 */ 
    bool restoreOnSync() const noexcept {return _restoreOnSync;}
	 ...
	 */
    bool noActions() const noexcept {return _noActions;}

    void restoreOnSync(bool b) noexcept {_restoreOnSync = b;}
    void noActions(bool b) noexcept {_noActions = b;}

/*
	Copyright 2018-2022, Exprivia SpA - DFDA
...
class EventNotifyFactorySingleton final : public Singleton< EventNotifyFactorySingleton> { // PRQA S 2109, 2153
public:
	~EventNotifyFactorySingleton() noexcept override = default ;
...
public:
	EventNotifyFactory();
	virtual ~EventNotifyFactory() noexcept;

	EventNotifyFactory(const EventNotifyFactory&) = delete ;
	EventNotifyFactory& operator=(const EventNotifyFactory&) = delete ;

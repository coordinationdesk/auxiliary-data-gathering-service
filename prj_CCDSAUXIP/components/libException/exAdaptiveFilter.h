...
public:
	...
	~exAdaptiveFilter() override = default ; 
	...
	*/
	bool filterInsertion(exFilterable &) override ;

private:
	bool _allowDebug = true ;
	bool _allowError = true ;
	bool _allowEvent = true ;
	bool _allowMessage = true ;
	bool _allowPrivateInfo = true ;
	bool _allowWarning = true ;
	bool _allowOpAlert = true ;
	bool _allowAnyFilterable = false ; 
	bool _allowMCFilterable = true ;
} ;

...
public:
	...
	~exFMCCritical() override = default ;
	template <typename T> 
...
template <> 
inline
exFMCCritical &exFMCCritical::operator<<(const MCParam &t) { MCScopedParams::add(t) ; return *this ;}

template <> 
inline
exFMCCritical &exFMCCritical::operator<<(const MCMetric &t) { MCScopedParams::add(t) ; return *this ;}

template <> 
inline
exFMCCritical &exFMCCritical::operator<<(const MCCode &t) { MCScopedParams::add(t) ; return *this ;}

template <> 
inline
exFMCCritical &exFMCCritical::operator<<(const MCFunction &t) { MCScopedParams::add(t) ; return *this ;}

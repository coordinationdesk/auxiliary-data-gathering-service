...
#define ATTRIBUTE_DEPRECATED __attribute__((deprecated("Use ACS_CLASS_XXX macro family instead"))) 
#else
#define ATTRIBUTE_DEPRECATED 
#endif
ATTRIBUTE_DEPRECATED static inline void exCLASS_END_DEBUG_D() { /* nop */ } // PRQA S 2134,2314,2645,4649 6
 ...
 * At initialization, the value will be the maximum of all linked ones.
 ...
 */
inline int getDebugValueFromEnv(const char *env) noexcept // PRQA S 2134
{
    return ( nullptr != env) ? std::atoi(env) : -1  ; // PRQA S 3232,3382,3385 
}
...
/*! \brief the class is used to create a manipulator-like inserter function \see explain */ 
  struct _ExplainEx { // PRQA S 2173, 2175
...
#include <exRTDebuggable.h> // NOSONAR - leave it here: uses macros defined on top

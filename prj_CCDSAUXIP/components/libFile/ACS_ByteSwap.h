...
*/
    ...
    */
            ...
            #ifndef __BIG_ENDIAN
                /* Typical: */
                #define LITTLE_ENDIAN  1234   //NOSONAR - shall be a macro!
                #define BIG_ENDIAN     4321   //NOSONAR - shall be a macro!   
                #define PDP_ENDIAN     3412   //NOSONAR - shall be a macro!    
            #else
                #define LITTLE_ENDIAN __LITTLE_ENDIAN   //NOSONAR - shall be a macro!
                #define BIG_ENDIAN __BIG_ENDIAN   //NOSONAR - shall be a macro!
                #define PDP_ENDIAN__PDP_ENDIAN   //NOSONAR - shall be a macro!
            #endif
        #else
            #define LITTLE_ENDIAN _LITTLE_ENDIAN   //NOSONAR - shall be a macro!
            #define BIG_ENDIAN _BIG_ENDIAN   //NOSONAR - shall be a macro!
            #define PDP_ENDIAN _PDP_ENDIAN   //NOSONAR - shall be a macro!
        #endif        
    #endif

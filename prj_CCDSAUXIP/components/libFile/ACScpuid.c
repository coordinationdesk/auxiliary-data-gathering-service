...
{
	unsigned int eax, ecx, edx ; /* NOSONAR - readability */
	unsigned int i ;

	i=1 ;
    __asm__ (   
#ifndef __x86_64__
            "pushl	%%ebx		;"			/* Preserve EBX register (-fPIC compatibility) *//* NOSONAR */
#else
            "pushq	%%rbx		;"			/* (as above, but on 64bit arch.s) *//* NOSONAR */
#endif
            "movl	%3,	%%eax	;"          /* NOSONAR */
            "cpuid				;"          /* NOSONAR */
#ifndef __x86_64__
            "popl	%%ebx		;"			/* Preserve EBX register (-fPIC compatibility) *//* NOSONAR */
#else
            "popq	%%rbx		;"			/* (as above, but on 64bit arch.s) *//* NOSONAR */
#endif
...
{
	int status ;
	unsigned int eax, ebx, ecx, edx ; /* NOSONAR - readability */
    unsigned int feature, signature ; /* NOSONAR - readability */
	unsigned int i ;
	...
	i=0 ;
        __asm__ (	
            ...
            "movl	%4,	%%eax	;"          /* NOSONAR */
            "cpuid				;"          /* NOSONAR */
            "movl	%%ebx, %1	;"			/* Save value of EBX in another register */  /* NOSONAR */
#ifndef __x86_64__
            "popl	%%ebx		;"			/* Preserve EBX register (-fPIC compatibility) */ /* NOSONAR */
#else
            "popq	%%rbx		;"			/* (as above, but on 64bit arch.s) */ /* NOSONAR */
	...
	ACScpuid_get_psn(unsigned char psn[12])
{
	...
	unsigned int eax, ecx, edx ; /* NOSONAR - readability */
	unsigned int i ;
	unsigned int feature, signature, psn1, psn2, psn3 ; /* NOSONAR - readability */

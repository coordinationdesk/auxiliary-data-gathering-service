...
{
public:				  
	fileOperation01Factory() = default ;
	~fileOperation01Factory() override = default ;
	fileOperation01Factory(const fileOperation01Factory &) = delete ;
	fileOperation01Factory &operator=(const fileOperation01Factory &) = delete ;

...
RemoteSite const& CirculationStatistics::getSourceSite() const noexcept // PRQA S 4120
{
    return _sourceSite;
}

RemoteSite const& CirculationStatistics::getDestSite() const noexcept // PRQA S 4120
{
    return _destSite;
}

...
public:
	...
	CirculationStatistics(const CirculationStatistics &) = default ;

	~CirculationStatistics() override = default ;
...
// the following columns have been added after jira issue S2PDGS-625
    ...
    RemoteSite const& getSourceSite() const noexcept ;
    RemoteSite const& getDestSite() const noexcept ;
...
using CirculationStatisticsQuery = db::SmartQuery<CirculationStatistics>  ;

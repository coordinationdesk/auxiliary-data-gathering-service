...
void FtpListItem::setField(Token token, string const &strRead) {
    ...
    case month:
            ...
            _month = DateTime::month2Num(strRead) ;
            break;
    case day:
...
const std::string &FtpListItem::getGroup() const noexcept { return _group; } // PRQA S 4120

const std::string &FtpListItem::getName() const noexcept { return _name; } // PRQA S 4120

long FtpListItem::getNumberOfFiles() const noexcept { return _numberOfFiles; } // PRQA S 4120

const std::string &FtpListItem::getOwner() const noexcept { return _owner; } // PRQA S 4120

const FilePermissions &FtpListItem::getPermissions() const noexcept { return _permissions; } // PRQA S 4120

long long FtpListItem::getSize() const noexcept { return _size; } // PRQA S 4120
...
void FtpListItem::setNumberOfFiles(long n) noexcept  // PRQA S 4121
{
    _numberOfFiles = n;
}
...
void FtpListItem::setSize(long long s) noexcept // PRQA S 4121
{
    _size = s;
}
...
const DateTime &FtpListItem::getDateTime() const noexcept // PRQA S 4120
{
    return _date ;
}

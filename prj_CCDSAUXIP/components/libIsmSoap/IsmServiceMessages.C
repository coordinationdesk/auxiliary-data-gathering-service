...
ostream &operator<<(ostream &s, const Ism__onCacheRequest &r)
{
...
ostream &operator<<(ostream &s, const enum Ism__onCacheResponseCodeEnum &r)
{
	string responseCode ;
	switch (r)  {
...
exostream &operator<<(exostream &s, const Ism__onCacheRequest &r)
{
	s 	<< "filePath = \"" 			<< r.filePath 			<< "\"\n"   	   
		<< "user = \"" 				<< r.user 				<< "\"\n"   	   
		<< "group = \"" 			<< r.group 				<< "\"\n" 	   
...
exostream &operator<<(exostream &s, const enum Ism__onCacheResponseCodeEnum &r)
{

...
enum Ism__onCacheResponseCodeEnum {
	onCacheCode_NOT_AVAILABLE = 0,
	onCacheCode_OFF = 1, 
	onCacheCode_IN_PROGRESS = 2, 
	onCacheCode_ON = 3
};
...
Ism__isFileOnCache( Ism__onCacheRequest *in, enum Ism__onCacheResponseCodeEnum *out);
Ism__putFileOnCache( Ism__onCacheRequest *in, enum Ism__onCacheResponseCodeEnum *out);
Ism__releaseCacheFile( Ism__onCacheRequest *in, struct Ism__releaseCacheResponse { } *out);

...
DefaultAbortCmd::DefaultAbortCmd() : ScAbstractCommand ()
{}


DefaultAbortCmd::DefaultAbortCmd(const DefaultAbortCmd& r) : ScAbstractCommand (r)
{
}


DefaultAbortCmd& DefaultAbortCmd::operator= (const DefaultAbortCmd& r)
{
	if (this != &r)
	{
...
void DefaultAbortCmd::execute (ExecutorBase& e)
{
	e.abort();
}

string DefaultAbortCmd::getSignature () const
{
	return "DefaultAbortCmd";
}

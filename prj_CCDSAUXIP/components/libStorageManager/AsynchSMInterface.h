...
public:
	...
	AsynchSMInterface() = delete ;
	AsynchSMInterface(const AsynchSMInterface &) = delete ;
	AsynchSMInterface &operator=(const AsynchSMInterface &) = delete ;
	AsynchSMInterface(AsynchSMInterface &&) = delete ;
	AsynchSMInterface &operator=(AsynchSMInterface &&) = delete ;

	virtual ~AsynchSMInterface() = default ;

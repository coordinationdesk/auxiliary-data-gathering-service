...
ScIpcClient::ScIpcClient(int fd) :
		TcpIpIpcClient<TlMessage>(fd)
{}

ScIpcClient::~ScIpcClient() throw() {}

string
ScIpcClient::tlMessage2XMLString (const TlMessage& m)
{
	ostringstream os;
	{
...
void
ScIpcClient::marshal (const TlMessage& aTlMessage)
{
...
string
ScIpcClient::packString (string& toPack)
{

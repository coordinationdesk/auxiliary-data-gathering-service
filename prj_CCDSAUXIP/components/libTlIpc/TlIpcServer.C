...
/*
	...
	$Log$
	Revision 5.0  2013/07/07 18:30:27  marpas
...
ACS_CLASS_DEFINE_DEBUG_LEVEL(TlIpcServer) ;


TlIpcServer::TlIpcServer() :
		TcpIpIpcServer<TlMessage> ()
{
}

TlIpcServer::~TlIpcServer() throw() {}


void
TlIpcServer::unmarshal (const string& s)
{
	try
	{
